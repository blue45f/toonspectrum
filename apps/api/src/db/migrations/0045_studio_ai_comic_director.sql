-- Durable AI Comic Director sessions, Visual Bible revisions, resumable jobs, artifacts and approvals.
-- The tables store metadata and asset references only; image bytes remain in Studio asset storage.
