...
// v7 is the first room protocol that accepts stroke payload v5 taper-aware spacing.
// Rejecting v1-v6 prevents stale tabs from reinterpreting the new station geometry.
