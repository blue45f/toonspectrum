...
export const THEME_SCENE_ASSETS: Readonly<Record<DesignTheme, ThemeSceneAsset>> = {
  aurora: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/aurora-motifs.svg",
    motion: "ribbon",
  ...
  blossom: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/blossom-motifs.svg",
    motion: "petals",
  ...
  starlight: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/starlight-motifs.svg",
  ...
  dark: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/ink-motifs.svg",
    motion: "ink",
  ...
  light: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/paper-motifs.svg",
    motion: "paper",
  ...
  graphite: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/graphite-motifs.svg",
    motion: "drafting",
  ...
  midnight: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/midnight-motifs.svg",
    motion: "rain",
  ...
  sepia: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/sepia-motifs.svg",
    motion: "scrapbook",
  ...
  contrast: {
    ...
    motifSrc: "/brand/theme-scenes/motifs/contrast-motifs.svg",
    motion: "focus",
