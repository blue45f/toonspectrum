...
const PROFILES: Record<SiteRouteVisualKind, SiteRouteVisualProfile> = {
  ...
  planning: {
    ...
    motion: "storyboard",
    density: "prominent",
    image: "/assets/studio/generated-backgrounds/gpt25-v1/daily/gpt25-bg-daily-corner-shop-rain-vertical-depth/background.png",
    imagePosition: "50% 50%",
    video: FILM(12, 18),
  ...
  spatial: {
    ...
    motion: "camera",
    density: "prominent",
    image: "/assets/studio/generated-backgrounds/gpt25-v1/sf/gpt25-bg-sf-space-station-platform-vertical-depth/background.png",
    imagePosition: "50% 54%",
    video: FILM(12, 18),
