/** Generated namespace manifest for domain/page locale assets. */
export const APP_I18N_NAMESPACES = [
  "account", "ad", "ageGate", "apiError", "app", "auth", "authors", "avatar", "bookmark", "changelog", "command", "common", "contact", "control", "copyright", "error", "feedback", "footer", "fortune", "home", "lang", "nav", "notify", "page", "play", "ranking", "review", "route", "search", "settings", "share", "titleFilter", "toast", "userProfile",
] as const;
export const STUDIO_I18N_NAMESPACES = [
