...
export const CAMPUS_DISTRICTS: readonly CampusDistrict[] = [
  { id: "plaza", artworkUrl: "/brand/atelier-world-640.webp", label: text("중앙 광장", "Central plaza"), description: text("만들고, 찾고, 만나고, 쉬는 창작 세계", "Create, discover, connect and unwind"), href: "/hub", zone: "lounge", destinations: [
  ...
  { id: "atelier", artworkUrl: "/assets/studio/backgrounds/webtoon_creator_room.png", label: text("내 아틀리에", "My atelier"), description: text("내 작품과 원고를 이어가는 작업실", "Your work, materials and manuscripts"), href: "/home", zone: "drawing", destinations: [
  ...
  { id: "production", artworkUrl: "/brand/product-tour/07-production.png", label: text("제작관·팀 작업실", "Production & team"), description: text("기획부터 검수와 전달까지 같은 작품으로", "Plan, review and deliver the same work"), href: "/production", zone: "writers", destinations: [
  ...
  { id: "market", artworkUrl: "/assets/studio/cc0-20260906/assets/polyhaven-background-leadenhall-market/background.webp", label: text("소재 거리", "Materials street"), description: text("찾고, 시험하고, 내 작업에 가져오는 재료", "Discover, try and use materials"), href: "/market", zone: "assets", destinations: [
  ...
  { id: "library", artworkUrl: "/assets/studio/cc0-20260906/assets/polyhaven-background-large-corridor/background.webp", label: text("이야기 도서관", "Story library"), description: text("작품·작가·출처 있는 참고자료", "Stories, creators and sourced references"), href: "/discover", zone: "writers", destinations: [
  ...
  { id: "gallery", artworkUrl: "/assets/studio/cc0-20260906/assets/polyhaven-background-wooden-lounge/background.webp", label: text("전시관·창작자 카페", "Gallery & creator cafe"), description: text("공개한 작품과 창작 경험을 나누는 곳", "Published works and creative conversations"), href: "/showcase", zone: "review", destinations: [
  ...
  { id: "academy", artworkUrl: "/brand/product-tour/08-learn.png", label: text("배움터·실험실", "Academy & laboratory"), description: text("예제와 실습에서 내 창작으로", "From lessons and practice to your own work"), href: "/learn", zone: "storyboard", destinations: [
  ...
  { id: "observatory", artworkUrl: "/assets/studio/backgrounds/webtoon_moonlit_forest.png", label: text("별빛 관측소", "Starlight observatory"), description: text("카드·전통·상징을 즐기는 나만의 시간", "Your private time with cards and symbolism"), href: "/fortune", zone: "lounge", destinations: [
  ...
  { id: "service", artworkUrl: "/assets/studio/backgrounds/webtoon_rooftop_sunset.png", label: text("안내·설정관", "Help & settings"), description: text("내 환경과 데이터, 사용 도움말", "Your preferences, data and help"), href: "/help", zone: "assistant", destinations: [
