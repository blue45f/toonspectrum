...
export const CAMPUS_DISTRICTS: readonly CampusDistrict[] = [
  { id: "plaza", label: text("중앙 광장", "Central plaza"), description: text("만들고, 찾고, 만나고, 쉬는 창작 세계", "Create, discover, connect and unwind"), href: "/hub", zone: "lounge", destinations: [
  ...
  { id: "atelier", label: text("내 아틀리에", "My atelier"), description: text("내 작품과 원고를 이어가는 작업실", "Your work, materials and manuscripts"), href: "/home", zone: "drawing", destinations: [
  ...
  { id: "production", label: text("제작관·팀 작업실", "Production & team"), description: text("기획부터 검수와 전달까지 같은 작품으로", "Plan, review and deliver the same work"), href: "/production", zone: "writers", destinations: [
  ...
  { id: "market", label: text("소재 거리", "Materials street"), description: text("찾고, 시험하고, 내 작업에 가져오는 재료", "Discover, try and use materials"), href: "/market", zone: "assets", destinations: [
  ...
  { id: "library", label: text("이야기 도서관", "Story library"), description: text("작품·작가·출처 있는 참고자료", "Stories, creators and sourced references"), href: "/discover", zone: "writers", destinations: [
  ...
  { id: "gallery", label: text("전시관·창작자 카페", "Gallery & creator cafe"), description: text("공개한 작품과 창작 경험을 나누는 곳", "Published works and creative conversations"), href: "/showcase", zone: "review", destinations: [
    destination("showcase", "작품 전시", "Showcase", "/showcase"), destination("community", "창작자 카페", "Community", "/community"), destination("challenges", "챌린지", "Challenges", "/showcase/challenges"), destination("creators", "창작자 만나기", "Meet creators", "/creators"),
  ] },
  { id: "academy", label: text("배움터·실험실", "Academy & laboratory"), description: text("예제와 실습에서 내 창작으로", "From lessons and practice to your own work"), href: "/learn", zone: "storyboard", destinations: [
    destination("learn", "배움터", "Learn", "/learn"), destination("recipes", "실습 교본", "Recipes", "/learn/recipes"), destination("manual", "제작 가이드", "Manual", "/studio/manual"), destination("ai", "개인 AI 실험실", "Personal AI lab", "/studio/ai-lab"), destination("tools", "제작 도구", "Toolchain", "/studio/toolchain"),
  ] },
  { id: "observatory", label: text("별빛 관측소", "Starlight observatory"), description: text("카드·전통·상징을 즐기는 나만의 시간", "Your private time with cards and symbolism"), href: "/fortune", zone: "lounge", destinations: [
  ...
  { id: "service", label: text("안내·설정관", "Help & settings"), description: text("내 환경과 데이터, 사용 도움말", "Your preferences, data and help"), href: "/help", zone: "assistant", destinations: [
