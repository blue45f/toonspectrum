...
export const CAMPUS_DISTRICTS: readonly CampusDistrict[] = [
  ...
  { id: "market", artworkUrl: "/assets/studio/backgrounds/webtoon_street.png", label: text("소재 거리", "Materials street"), description: text("찾고, 시험하고, 내 작업에 가져오는 재료", "Discover, try and use materials"), href: "/market", zone: "assets", destinations: [
  ...
  { id: "library", artworkUrl: "/assets/studio/backgrounds/webtoon_classroom.png", label: text("이야기 도서관", "Story library"), description: text("작품·작가·출처 있는 참고자료", "Stories, creators and sourced references"), href: "/discover", zone: "writers", destinations: [
  ...
  { id: "gallery", artworkUrl: "/assets/studio/backgrounds/webtoon_cafe.png", label: text("전시관·창작자 카페", "Gallery & creator cafe"), description: text("공개한 작품과 창작 경험을 나누는 곳", "Published works and creative conversations"), href: "/showcase", zone: "review", destinations: [
