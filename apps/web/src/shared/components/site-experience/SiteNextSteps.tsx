import { ArrowUpRight, BookOpen, CalendarDays, Compass, Images, Library, MessageCircle, Search, Sparkles, Store } from "lucide-react";
...
/** Contextual exits, rather than the same marketing CTA on every page. */
    ...
    <section className="site-next-steps" aria-labelledby={headingId} data-testid="site-next-steps">
      ...
      <div className="site-next-steps__heading">
        ...
        <button type="button" className="site-experience-toggle" aria-pressed={settings.mode === "calm"}
          ...
          {locale === "ko" ? "차분한 화면" : "Calm appearance"}
        </button>
      </div>
