...
export const PUBLIC_JOURNEY = [
  ...
  { id: "make", href: "/make", ko: "장면 그리기", en: "Create", koDescription: "아이디어를 준비했다면 창작 공간에서 시작하세요.", enDescription: "Turn your idea into a scene in the creative workspace.", paths: ["/make"] },
