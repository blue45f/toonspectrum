...
export const PALETTE_COMMANDS: PaletteCommand[] = [
  ...
  },
  {
    ...
    description: "수천 편의 카탈로그 중에서 엄선된 추천 웹툰을 무작위로 뽑아 미리 보고 선택합니다.",
    action: (ctx) => {
      ctx.playSfx("pop");
      ctx.closePalette();
...
export const PALETTE_PAGES: PalettePage[] = [
  {
    ...
    href: "/",
    title: "홈",
    subtitle: "이어하기와 목적별 시작",
    icon: Sparkles,
    category: "main",
    keywords: ["홈", "메인", "이어하기", "시작", "home", "main"],
  },
  {
    id: "page-discover-hub",
    href: "/discover",
    title: "찾기",
    subtitle: "검색·취향 탐색·추천·랭킹·캘린더를 목적별로 선택",
    icon: Compass,
    category: "main",
    keywords: ["찾기", "검색", "탐색", "추천", "랭킹", "discover", "find", "search"],
  },
  {
    id: "page-make-hub",
    href: "/make",
  ...
  },
  {
    ...
    href: "/my",
    title: "내 공간",
    subtitle: "프로젝트·내 작품·서재·에셋·활동·프로필·설정",
    icon: Library,
    category: "main",
    keywords: ["내공간", "내 공간", "프로젝트", "서재", "에셋", "프로필", "my", "account"],
  },
  {
    id: "page-help-center",
    href: "/help",
    title: "도움말 센터",
    subtitle: "작업 목적과 문제에서 기능·가이드·복구 경로 검색",
    icon: HelpCircle,
    category: "main",
    keywords: ["도움말", "문의", "문제", "복구", "가이드", "help", "support", "recovery"],
  },
  {
    id: "page-ranking",
    href: "/ranking",
    title: "다축 통합 랭킹",
    subtitle: "인기·별점·정주행·성장세 기준 랭킹",
    icon: TrendingUp,
    shortcut: ["G", "R"],
    category: "discover",
