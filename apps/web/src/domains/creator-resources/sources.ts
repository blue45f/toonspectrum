...
export const RESOURCE_SOURCES: ResourceSource[] = [
  ...
  { name: "기업마당", category: "창작 기회", status: "무료 발급 양식 확인·운영키 등록 대기", commercial: "조건부 상업 이용", url: "https://www.bizinfo.go.kr/apiDetail.do?id=bizinfoApi", note: "지원사업 어댑터가 구현되어 있습니다. BIZINFO_API_KEY 필요. 접수 상태·정확한 마감 시간·신청 자격은 공식 공고 원문을 확인합니다." },
  ...
  { name: "Google Books", category: "글로벌 판본", status: "무료 제한키 발급·검색 어댑터 구현", commercial: "조건부 상업 이용", url: "https://developers.google.com/books/docs/v1/using", note: "결제 계정이 연결되지 않은 전용 프로젝트에서 Books API로만 제한한 서버 키를 발급했습니다. 해외 판본·언어·ISBN 메타데이터를 통합 검색하며 표지·미리보기·본문은 가져오지 않습니다. 사용자 개인 서재는 별도 OAuth와 동의가 있을 때만 연결합니다." },
  { name: "Wikidata·Wikimedia", freeKeyless: true, category: "지식 그래프·CC0 이미지", status: "키 없는 Commons CC0 검색 구현", commercial: "조건부 상업 이용", url: "https://www.mediawiki.org/wiki/Wikimedia_APIs", note: "Open Creation에서 Commons 파일의 LicenseShortName이 정확히 CC0이고 출처·미리보기 호스트와 제한 없음이 확인된 경우만 표시합니다. 파일별 저작자·크레딧·조회일·원문 링크를 보존하며, 그 밖의 CCL 이미지는 현재 가져오지 않습니다." },
  ...
  { name: "YouTube Data API", category: "공식 영상", status: "무료 제한키 발급·운영 연결 대기", commercial: "조건부 상업 이용", url: "https://developers.google.com/youtube/v3", note: "공식 예고편·인터뷰·학습 영상의 원문 연결 후보입니다. 영상 파일 수집·재편집·외부 지표와의 임의 합산은 하지 않습니다." },
