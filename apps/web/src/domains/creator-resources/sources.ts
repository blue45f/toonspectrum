...
export const RESOURCE_SOURCES: ResourceSource[] = [
  ...
  { name: "NEIS 교육정보 Open API", freeAccess: true, integration: "운영 연결", auth: "API 키", rights: "메타데이터 전용", importMode: "검색·원문 링크", termsReviewedAt: "2026-09-25", productRoute: "/research/open-data/neis", category: "학교·학사일정·시간표", status: "무료 운영키 발급·Cloudflare 엣지 검색 연결", commercial: "조건부 상업 이용", url: "https://open.neis.go.kr/portal/guide/apiGuidePage.do", note: "학교명·학교급·설립구분·주소를 학교물 설정에 연결합니다. 키 응답 장애 시 공식 무키 샘플 5건으로 축소해 계속 검색하며, 실제 학사일정·시간표·행사는 학교와 교육청의 최신 공지를 확인하고 개인 식별정보는 사용하지 않습니다." },
