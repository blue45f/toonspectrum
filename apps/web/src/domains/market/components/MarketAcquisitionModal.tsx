          ...
          <div className="space-y-4 p-5">
            ...
            <div className="space-y-2 rounded-xl border border-good/40 bg-good/10 p-3.5">
              <div className="flex items-center justify-between gap-3">
                <span className="text-xs font-semibold text-fg">{translateCurrentStaticSourceText("domains.market.components.MarketAcquisitionModal", "ko", "이용 비용")}</span>
                <span className="text-sm font-extrabold text-good">{translateCurrentStaticSourceText("domains.market.components.MarketAcquisitionModal", "ko", "무료")}</span>
              </div>
              <p className="text-[0.68rem] leading-relaxed text-fg-3">
                {translateCurrentStaticSourceText("domains.market.components.MarketAcquisitionModal", "ko", "비용은 없지만 사용권 조건은 적용됩니다. 상업 이용·수정·출처 표기 범위를 아래에서 확인하세요.")}</p>
            ...
            <div className="flex items-center justify-end gap-2 border-t border-line pt-4">
              ...
              >
                ...
                <span>{submitting
                  ...
                  : versionNotice
                    ? formatI18nTemplate(translateCurrentStaticSourceText("domains.market.components.MarketAcquisitionModal", "ko", "현재 v{v0} 조건 확인 후 추가"), { v0: String(activeRecord.resourceVersion) })
                    : translateCurrentStaticSourceText("domains.market.components.MarketAcquisitionModal", "ko", "내 에셋에 추가")}</span>
              </button>
            </div>
          </div>
        )}
