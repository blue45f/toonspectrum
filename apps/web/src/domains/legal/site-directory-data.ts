...
export const SITEMAP_EXTENDED_DESTINATION_GROUPS: readonly ExtendedDestinationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      destination("/research/creatures", "생물·크리처 자료", "Creature references", "GBIF 생물 분류와 관찰 자료를 캐릭터·크리처 고증에 활용", "Use GBIF taxonomy and observations for character and creature research"),
      destination("/research/music-metadata", "음악 메타데이터", "Music metadata", "MusicBrainz의 곡·아티스트·발매 정보를 장면 기획에 활용", "Use MusicBrainz recordings, artists and releases in scene planning"),
      destination("/research/archive", "인터넷 아카이브", "Internet Archive", "공개 아카이브의 책·영상·음원을 출처와 함께 탐색", "Explore openly archived books, video and audio with source evidence"),
      destination("/research/weather-light", "날씨·빛 자료", "Weather & light", "기상 관측을 장면의 날씨·조명 레퍼런스로 변환", "Turn weather observations into scene and lighting references"),
      destination("/research/open-data/kheritage", "국가유산 자료", "Korean heritage data", "국가유산청 공개 자료로 건축·복식·소품을 고증", "Research architecture, costume and props with Korean heritage data"),
      destination("/research/open-data/neis", "학교 공간 자료", "School data", "NEIS 학교 정보를 학원물·학교 배경 기획에 활용", "Use NEIS school data for campus stories and environments"),
      destination("/research/open-data/tourapi", "관광지 자료", "Tour data", "TourAPI의 장소·문화·축제 정보를 로케이션 레퍼런스로 활용", "Use TourAPI places, culture and festivals as location references"),
      destination("/research/open-data/korean", "한국어 사전", "Korean dictionary", "공식 사전의 뜻·용례로 대사와 명칭을 다듬기", "Refine dialogue and naming with official dictionary meanings and examples"),
      destination("/research/open-data/smithsonian", "Smithsonian 자료", "Smithsonian collections", "박물관 소장품을 시대·재료·출처와 함께 탐색", "Explore museum objects with period, material and provenance"),
      destination("/research/open-data/wikimedia", "Wikimedia 관심도", "Wikimedia interest", "문서·조회 데이터를 소재 조사와 트렌드 참고에 활용", "Use article and view data for research and trend context"),
      destination("/research/open-data/europeana", "Europeana 문화자료", "Europeana culture", "유럽 문화유산 자료를 권리 정보와 함께 탐색", "Explore European cultural heritage with rights information"),
      destination("/research/open-data/dpla", "DPLA 문화자료", "DPLA collections", "미국 도서관·박물관 공개 자료를 장면 고증에 활용", "Use public US library and museum collections for scene research"),
      destination("/research/open-data/ambientcg", "ambientCG 공개 데이터", "ambientCG open data", "CC0 재질·HDRI·3D 에셋 데이터를 API 관점에서 탐색", "Explore CC0 materials, HDRIs and 3D assets through open data"),
      destination("/research/open-data/vam", "V&A 공개 데이터", "V&A open data", "패션·가구·장식미술 컬렉션을 API 자료로 탐색", "Explore fashion, furniture and decorative arts through V&A data"),
      destination("/research/open-data/nasa", "NASA 공개 데이터", "NASA open data", "우주·행성·과학 이미지를 공개 데이터로 탐색", "Explore space, planetary and science imagery as open data"),
      destination("/research/open-data/gbif", "GBIF 공개 데이터", "GBIF open data", "생물 분류·서식·관찰 정보를 공개 데이터로 탐색", "Explore taxonomy, habitat and observations as open data"),
      destination("/research/open-data/musicbrainz", "MusicBrainz 공개 데이터", "MusicBrainz open data", "음악·아티스트·발매 메타데이터를 공개 데이터로 탐색", "Explore recording, artist and release metadata as open data"),
      destination("/research/open-data/internetarchive", "Internet Archive 공개 데이터", "Internet Archive data", "아카이브 메타데이터와 공개 미디어를 API로 탐색", "Explore archive metadata and open media through its API"),
