...
import { normalizePolicyDocument, type PolicyDocument } from "@toonspectrum/core/legal-policies";

export const TERMSDESK_BASE = "https://termsdesk.vercel.app";
export const TERMSDESK_ORG_SLUG = "toonspectrum";

export { getStaticPolicyDocument } from "@toonspectrum/core/legal-policies";
export type { PolicyDocument, PolicySlug } from "@toonspectrum/core/legal-policies";
...
export async function fetchPolicyDocument(slug: string, signal?: AbortSignal): Promise<PolicyDocument> {
  ...
  return normalizePolicyDocument(payload, slug);
}
