    ...
    <>
      <section className="mt-8 rounded-3xl border border-line bg-panel/55 p-5 sm:p-7" aria-labelledby="accessibility-lab-title">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)]">
          ...
          >
            <span className="inline-flex min-h-8 items-center gap-2 rounded-full border border-good/40 bg-good/10 px-3 text-[0.75em] font-bold text-fg">
              <CheckCircle2 size="1em" className="text-good" aria-hidden="true" />{translateCurrentStaticSourceText("domains.legal.AccessibilityLab", "en", "SAVE COMPLETE")}</span>
