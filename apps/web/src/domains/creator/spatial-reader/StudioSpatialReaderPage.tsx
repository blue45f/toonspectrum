...
export function StudioSpatialReaderPage(){
  ...
  return <main className="advanced-studio"><header><div><p className="eyebrow">TOONSTUDIO / SPATIAL READER</p><h1>웹툰의 공간 안으로</h1><p>컷·대사·깊이 레이어를 보존하는 감상 모드. 일반 화면, VR, AR에서 같은 작품을 읽습니다.</p></div><nav><Link to="/studio/generate">생성형 스튜디오</Link><a href="/offline-drawing.html">로컬 드로잉</a><Link to="/studio">스튜디오 홈</Link></nav></header>
