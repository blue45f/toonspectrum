...
export const STUDIO_VIRTUAL_PLACES: readonly StudioVirtualPlaceDefinition[] = Object.freeze([
  place({ id: "skyport", roomId: "lobby", category: "community", labelKo: "스카이 포트", labelEn: "Sky Port",
  ...
  place({ id: "creator-plaza", roomId: "live", category: "community", labelKo: "창작자 광장", labelEn: "Creator Plaza",
  ...
  place({ id: "personal-atelier", roomId: "drawing", category: "creation", labelKo: "개인 아틀리에", labelEn: "Personal Atelier",
  ...
  place({ id: "story-lab", roomId: "writers", category: "creation", labelKo: "스토리 랩", labelEn: "Story Lab",
  ...
  place({ id: "creator-cafe", roomId: "lounge", category: "rest", labelKo: "크리에이터 카페", labelEn: "Creator Cafe",
    descriptionKo: "짧은 대화와 휴식을 위한 정원형 카페.", descriptionEn: "A garden cafe for brief conversations and breaks.", action: "community" }),
  place({ id: "team-meeting", roomId: "meeting", category: "collaboration", labelKo: "팀 미팅 로프트", labelEn: "Team Meeting Loft",
  ...
  place({ id: "tree-library", roomId: "assets", category: "archive", labelKo: "트리 라이브러리", labelEn: "Tree Library",
  ...
  place({ id: "review-gallery", roomId: "review", category: "review", labelKo: "리뷰 갤러리", labelEn: "Review Gallery",
  ...
  place({ id: "garden", roomId: "assistant", category: "rest", labelKo: "창작 정원", labelEn: "Creator Garden",
    descriptionKo: "아이디어를 정리하고 잠시 쉬어가는 폭포 정원.", descriptionEn: "A waterfall garden for reflection and quiet breaks.", action: "assistant" }),
  place({ id: "observatory", roomId: "quality", category: "review", labelKo: "스토리 관측소", labelEn: "Story Observatory",
    descriptionKo: "프로젝트 흐름과 품질 상태를 멀리서 조망하는 곳.", descriptionEn: "An observatory for project flow and quality signals.", action: "review" }),
  place({ id: "arcade", roomId: "storyboard", category: "play", labelKo: "크리에이터 아케이드", labelEn: "Creator Arcade",
  ...
  place({ id: "beach", roomId: "lounge", category: "rest", labelKo: "해변 아틀리에", labelEn: "Beach Atelier",
  ...
  place({ id: "event-stage", roomId: "live", category: "community", labelKo: "이벤트 스테이지", labelEn: "Event Stage",
    descriptionKo: "발표와 라이브 행사를 진행하는 공개 무대.", descriptionEn: "A public stage for presentations and live events.", action: "live" }),
  place({ id: "production-control", roomId: "production", category: "production", labelKo: "프로덕션 관제실", labelEn: "Production Control",
