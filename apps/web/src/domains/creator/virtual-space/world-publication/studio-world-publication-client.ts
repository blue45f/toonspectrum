import { canonicalJson, studioWorldManifestSchema, studioWorldPublicationSchema, type StudioWorldPublication,
  type StudioWorldPublish } from "@toonspectrum/studio-project-model";
import { z } from "zod";
