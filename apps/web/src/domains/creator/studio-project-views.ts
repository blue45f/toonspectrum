...
> = Object.freeze({
  overview: Object.freeze({
    summary: { ko: "한눈에 보기", en: "At a glance" },
    activity: { ko: "최근 작업", en: "Recent work" },
    readiness: { ko: "완성 준비", en: "Readiness" },
    intelligence: { ko: "작품 점검", en: "Project checks" },
  }),
  story: Object.freeze({
    overview: { ko: "작품 설정", en: "Project setup" },
  ...
  production: Object.freeze({
    ...
    pipeline: { ko: "작업 단계", en: "Workflow" },
    calendar: { ko: "일정", en: "Calendar" },
    workload: { ko: "담당 작업", en: "Assignments" },
    renders: { ko: "처리 작업", en: "Processing" },
  }),
  assets: Object.freeze({
    project: { ko: "프로젝트", en: "Project" },
    series: { ko: "작품 스타일", en: "Project style" },
    team: { ko: "팀", en: "Team" },
    installed: { ko: "사용 중", en: "In use" },
    missing: { ko: "확인 필요", en: "Needs attention" },
    rights: { ko: "사용 권리", en: "Rights" },
  }),
  review: Object.freeze({
    inbox: { ko: "확인할 요청", en: "Requests" },
    comments: { ko: "댓글", en: "Comments" },
    requests: { ko: "수정 요청", en: "Change requests" },
    approvals: { ko: "승인", en: "Approvals" },
    versions: { ko: "버전", en: "Versions" },
    compare: { ko: "전후 비교", en: "Before & after" },
    share: { ko: "공유", en: "Share" },
  }),
  export: Object.freeze({
    preflight: { ko: "출력 전 검사", en: "Pre-export check" },
    targets: { ko: "사용할 곳", en: "Destinations" },
    localization: { ko: "언어별 출력", en: "Localization" },
    packages: { ko: "만든 파일", en: "Created files" },
  ...
  settings: Object.freeze({
    ...
    automation: { ko: "자동 작업", en: "Automation" },
    defaults: { ko: "기본 설정", en: "Defaults" },
    archive: { ko: "보관·삭제", en: "Archive & delete" },
  }),
});
