...
export default function StudioP2pHuddleLauncher() {
  ...
  return <aside
    className="studio-p2p-huddle-dock fixed bottom-[calc(var(--studio-canvas-bottom-inset,7rem)+4.25rem)] right-3 z-[53] max-w-[calc(100vw-1.5rem)] sm:bottom-3 sm:z-[65]"
