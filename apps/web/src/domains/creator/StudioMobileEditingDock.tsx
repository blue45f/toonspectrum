...
function StudioMobileScrollCues({
  ...
  return (
    <>
      <span
        aria-hidden
        data-studio-mobile-scroll-cue={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "{v0}-before"), { v0: String(placement) })}
      ...
      <span
        aria-hidden
        data-studio-mobile-scroll-cue={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "{v0}-after"), { v0: String(placement) })}
      ...
      <span
        ...
        className="sr-only"
      >
        {translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "도구막대를 좌우로 밀면 숨은 도구를 볼 수 있습니다.")}</span>
    </>
  );
}
...
function StudioMobileFilterSelect({
  ...
  if (disabled) {
    return (
      <button
        ...
        aria-disabled="true"
        aria-label={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 필터를 사용할 수 없음"), { v0: String(filterTargetLabel) })}
        aria-describedby={guidanceId}
        className={shellClassName}
        title={guidance}
      >
        <WandSparkles size={16} aria-hidden />
        <span>{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "필터")}</span>
  ...
  return (
    ...
    >
      ...
      <span id={guidanceId} className="sr-only">{guidance}</span>
      <select
        aria-label={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 필터 선택"), { v0: String(filterTargetLabel) })}
        aria-describedby={guidanceId}
        defaultValue=""
        title={guidance}
      ...
      >
        <option value="" disabled>{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "필터 선택")}</option>
  ...
  return (
    <>
        ...
        {isMobile && !mobileSheet && !quickActionsOpen && !showMobileHint && (selected || marqueeIds.length > 0) ? (
          <div
            role="toolbar"
            aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "선택 항목 빠른 작업")}
          ...
          >
            <div className="w-[4.75rem] shrink-0 px-2">
              <p className="truncate text-[0.68rem] font-bold text-fg">
                {marqueeIds.length > 0
                  ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0}개 선택"), { v0: String(marqueeIds.length) })
                  : selected
                    ? elementLabel(selected)
                    : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "선택")}
              </p>
              <p className="text-[0.58rem] font-medium uppercase tracking-wide text-fg-3">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "빠른 작업")}</p>
            </div>
            <span aria-hidden className="h-8 w-px shrink-0 bg-line" />
            <StudioContextActionButton
              icon={SlidersHorizontal}
              label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "속성")}
            ...
            {selectionTextEditLabel && marqueeIds.length === 0 ? (
              <StudioContextActionButton
                ...
                title={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} · 요소를 더블탭해도 열려요"), { v0: String(selectionTextEditLabel) })}
            ...
            {selected?.type === "image" && marqueeIds.length === 0 ? (
              <>
                <StudioContextActionButton
                  icon={PaintBucket}
                  label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "채우기")}
                  active={advancedFillActive}
                  title={advancedFillUnsupportedReason
                    ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 눌러서 사용할 수 있는 래스터를 찾거나 조건을 확인하세요."), { v0: String(advancedFillUnsupportedReason) })
                    : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "고급 채우기")}
                  onClick={toggleAdvancedFill}
                />
              </>
            ) : null}
            <StudioContextActionButton icon={Copy} label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "복제")} onClick={duplicateSelected} />
            {selected && marqueeIds.length === 0 ? (
              <>
                <StudioContextActionButton icon={ArrowUpToLine} label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "앞으로")} onClick={() => reorder("front")} />
                <StudioContextActionButton icon={ArrowDownToLine} label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "뒤로")} onClick={() => reorder("back")} />
              </>
            ) : null}
            ...
            <StudioContextActionButton
              ...
              label={selectionLocked ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "잠금 해제") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "잠금")}
              className="whitespace-nowrap"
              active={selectionLocked}
              title={selectionLocked
                ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "잠금을 풀어 다시 이동·변형·편집할 수 있게 합니다.")
                : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "선택 요소를 고정해 실수로 이동하거나 편집하지 않도록 보호합니다.")}
              onClick={toggleSelectionLock}
            />
            <StudioContextActionButton icon={Trash2} label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "삭제")} danger onClick={removeSelected} />
            <StudioContextActionButton
              icon={X}
              label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "해제")}
              onClick={() => {
                setSelectedId(null);
                setMarqueeIds([]);
              }}
        ...
        {showMobileHint && !mobileSheet && !quickActionsOpen && (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[0.8rem] font-semibold text-fg">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "한 손으로 그려보세요")}</p>
              <p className="mt-0.5 text-[0.72rem] leading-snug text-fg-3">
                {translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "아래 막대에서 ")}<span className="font-medium text-fg-2">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "펜·픽셀 펜·지우개·도형")}</span>{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "을 고르고,")}{" "}
                <span className="font-medium text-fg-2">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시")}</span>{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "를 눌러 굵기·색을 바꿔요. 두 손가락으로 이동·확대하고, 짧게 두 손가락 톡은 되돌리기·세 손가락 톡은 다시 실행이에요.")}</p>
            </div>
            <button
              type="button"
              onClick={dismissMobileHint}
              className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-3 hover:bg-raised"
              aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "안내 닫기")}
            >
        ...
        {isMobile && mobileSheet === "brushes" ? (
          <div
            ...
            aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "내 브러시 관리")}
            tabIndex={-1}
          ...
          >
            <div className="sticky top-0 z-10 -mx-3 mb-2 border-b border-line bg-panel/95 px-3 backdrop-blur">
              <StudioMobileSheetHandle
                active
                kind="brushes"
                label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "내 브러시 관리")}
              ...
              <div className="flex min-h-12 items-center justify-between">
                <div>
                  <p className="text-sm font-bold text-fg">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "내 브러시 관리")}</p>
                  <p className="text-[0.68rem] text-fg-3">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "저장·고정·복제·이름 변경·내보내기")}</p>
                </div>
                <button
                  type="button"
                  ...
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 관리 닫기")}
                  data-autofocus
                >
            ...
            <Suspense fallback={<p className="py-6 text-center text-xs text-fg-3">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시를 불러오는 중…")}</p>}>
              <StudioBrushLibraryPanel
        ...
        {isMobile && (
          <div
            ...
            ref={drawSheetRef}
            role={drawSettingsVisible ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "dialog") : undefined}
            aria-label={drawSettingsVisible ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 설정") : undefined}
            ...
            data-studio-mobile-sheet={mobileSheet === "draw" ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "draw") : undefined}
          ...
          >
            <div className="sticky -top-3 z-10 -mx-3 -mt-3 mb-2 border-b border-line/70 bg-panel/95 px-3 backdrop-blur">
              <StudioMobileSheetHandle
                ...
                kind="draw"
                label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 설정")}
              ...
              <div className="flex min-h-12 items-center justify-between">
                <p className="text-sm font-semibold text-fg">
                  {drawMode === "eraser"
                    ? eraserPresetActive ? activeCatalogBrushName : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "지우개")
                    : drawMode === "shape"
                      ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "도형")
                      : drawMode === "pixel"
                        ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "픽셀 펜")
                        : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시")} {translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "설정")}</p>
                <button
                  type="button"
                  ...
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 설정 닫기")}
                  data-autofocus
                >
            ...
            <div className="mb-2.5 space-y-2.5">
              {drawMode !== "pixel" ? <div>
                <span className="mb-1 flex items-center justify-between text-[0.7rem] font-medium text-fg-3">
                  <span>{drawMode === "eraser" ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "지우개 굵기") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "굵기")}</span>
                ...
                <div className="grid grid-cols-[minmax(0,1fr)_4.5rem] items-center gap-2">
                  <input
                    ...
                    aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 굵기 슬라이더")}
                  />
                  <label className="sr-only" htmlFor="mobile-brush-width">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 굵기 숫자")}</label>
                  <input
              ...
              {(drawMode !== "eraser" || eraserPresetActive) && (
                <div>
                  <span className="mb-1 flex items-center justify-between text-[0.7rem] font-medium text-fg-3">
                    <span>{drawMode === "eraser" ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "지우기 강도") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "불투명도")}</span>
                  ...
                  <div className="grid grid-cols-[minmax(0,1fr)_4.5rem] items-center gap-2">
                    <input
                      ...
                      className="h-11 w-full accent-accent"
                      aria-label={drawMode === "eraser" ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "지우기 강도 슬라이더") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 불투명도 슬라이더")}
                    />
                    <label className="sr-only" htmlFor="mobile-brush-opacity">
                      {drawMode === "eraser" ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "지우기 강도 숫자") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 불투명도 숫자")}
                    </label>
                    <input
                  ...
                  {drawMode !== "eraser" ? (
                    <p className="mt-1 text-[0.62rem] leading-relaxed text-fg-3">
                      {translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "100%는 색이 가장 또렷하고, 낮을수록 아래 색이 비쳐요.")}</p>
                  ) : null}
                </div>
              )}
            </div>
            ...
            {drawMode !== "eraser" && (
              <div className="mb-2.5">
                <p className="mb-1 text-[0.7rem] font-medium text-fg-3">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "색상")}</p>
                <div className="flex flex-wrap items-center gap-2">
                  {DRAW_COLOR_SWATCHES.map((swatch) => (
                    <button
                      ...
                      aria-label={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "색상 {v0}"), { v0: String(swatch) })}
                  ...
                  <label
                    ...
                    title={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "사용자 정의 색상")}
                  ...
                  >
                    <input
                      ...
                      aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "사용자 정의 브러시 색상")}
            ...
            <div className="mb-2.5 grid grid-cols-4 gap-1 rounded-xl border border-line bg-card/60 p-1" role="group" aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "그리기 모드")}>
              {([
            ...
            {drawMode === "pixel" ? (
              ...
              >
                ...
                <span className="min-w-0">
                  <strong className="block text-xs font-extrabold text-fg">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "픽셀 펜 · 1px 고정")}</strong>
                  <span className="mt-1 block text-[0.68rem] leading-relaxed text-fg-3">
                    {translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "격자 정렬 · 안티앨리어싱 없음 · 필압 없음 · 선 보정 없음")}</span>
                </span>
              </div>
            ) : null}
                ...
                >
                  ...
                  <span className="min-w-0">
                    ...
                    <span className="mt-0.5 block text-[0.68rem] leading-relaxed text-fg-3">
                      {eraseToIntersection
                        ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "켜짐 · 자유선 위를 탭하면 교차 사이만 지웁니다")
                        : STUDIO_ERASE_TO_INTERSECTION_TIP}
                    </span>
                  </span>
                </button>
            ...
            {drawMode === "eraser" && mobileSheet === "draw" ? (
              <section
                aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "지우개 종류")}
                className="mb-2.5 rounded-2xl border border-line/70 bg-card/45 p-2"
              >
                <div className="mb-2 flex items-center justify-between gap-2 px-1">
                  <div>
                    <p className="text-xs font-extrabold text-fg">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "지우개 종류")}</p>
                    <p className="mt-0.5 text-[0.66rem] text-fg-3">
                      {translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "한 번에 지울 양과 남는 결과를 보고 선택하세요.")}</p>
                  </div>
                </div>
                <StudioEraserQuickPicker
                  selectedId={activeEraserQuickId}
                  onSelect={(id) => brushCatalogHandlers.selectBrushId(id)}
                  ariaLabel={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "모바일 지우개 종류 빠른 선택")}
                />
              </section>
            ) : null}
            ...
            {drawMode === "pen" && mobileSheet === "draw" && (
              <>
                ...
                {livingInk.supported ? (
                  <section
                    aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "수채 번짐 빠른 도구")}
                  ...
                  >
                    <div className="mb-1.5 flex items-center justify-between gap-2 px-0.5">
                      <p className="text-[0.68rem] font-bold text-fg-2">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "수채 번짐")}</p>
                      <p className="text-[0.6rem] text-fg-3">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "안료 · 물 · 정착 · 지우기 · 크기·농도는 위와 동일")}</p>
                    </div>
            ...
            {drawMode === "pen" ? (
              ...
              data-studio-brush-preset-modified={
                brushDefaultRestoreModified ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "true") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "false")
              }
              ...
              <div className="flex items-center gap-2.5">
                <div className="min-w-0 flex-1">
                  <p className="truncate text-[0.7rem] font-semibold text-fg-2">
                    {brushDefaultRestore.sourceName} {translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "기본값")}</p>
                  <p
                ...
                <button
                  ...
                  aria-label={
                    brushDefaultRestore.loading
                      ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 기본값을 불러오는 중"), { v0: String(brushDefaultRestore.sourceName) })
                      : !brushDefaultRestore.available
                        ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 기본값 없음, 브러시를 다시 선택하세요"), { v0: String(brushDefaultRestore.sourceName) })
                        : brushDefaultRestore.undoAvailable
                          ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 기본값 복원 되돌리기"), { v0: String(brushDefaultRestore.sourceName) })
                          : brushDefaultRestoreModified
                            ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 기본값으로 복원, 변경된 설정 {v1}개"), { v0: String(brushDefaultRestore.sourceName), v1: String(brushDefaultRestore.modifiedCount) })
                            : formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 기본값, 변경된 설정 없음"), { v0: String(brushDefaultRestore.sourceName) })
                  }
            ...
            {drawMode === "shape" && (
              <div className="mt-2.5 border-t border-line/60 pt-2.5">
                <p className="mb-1.5 text-[0.7rem] font-semibold uppercase tracking-wider text-fg-3">
                  {translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "도형 모양")}</p>
                ...
                <button
                  ...
                  title={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "채우기")}
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "도형 채우기")}
        ...
        {isMobile && colorVisionOpen ? (
          <section
            ...
            role="dialog"
            aria-modal="true"
            aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "색각 검수")}
            tabIndex={-1}
            data-studio-mobile-sheet="true"
            data-studio-shortcut-boundary="true"
          ...
          >
            <div className="mb-2 flex items-center justify-between gap-3">
              <div className="min-w-0">
                <h2 className="text-[0.8rem] font-bold text-fg">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "색각·명암 검수")}</h2>
                <p className="text-[0.68rem] text-fg-3">{translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "원고를 바꾸지 않고 화면 표시만 전환합니다.")}</p>
              </div>
              <button
                type="button"
                onClick={() => setMobileSheet(null)}
                className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-2 hover:bg-raised"
                aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "색각 검수 닫기")}
              >
        ...
        {isMobile && (
          <nav
            ...
            data-studio-mobile-dock-expanded={workspaceDockExpanded ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "true") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "false")}
          ...
          >
            ...
            <div className="flex min-w-0 items-stretch gap-1">
              ...
              >
                <div
                  ...
                  aria-describedby={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "{v0}-primary"), { v0: String(scrollDescriptionId) })}
                  data-studio-mobile-dock-scroll="primary"
                >
              <StudioDockButton
                icon={MousePointer2}
                label={label.select}
                hintDescription={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "요소를 선택해 이동·크기 조절·정렬하고 속성 패널에서 세부 값을 편집합니다.")}
                hintShortcut="V"
              ...
              <StudioDockButton
                ...
                hintDescription={penModeActive
                  ? drawSettingsOpen
                    ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "열려 있는 브러시 설정을 닫고 펜으로 그리던 캔버스로 돌아갑니다.")
                    : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "펜은 유지하고 브러시 설정을 열어 굵기·색·필압·보정을 조절합니다.")
                  : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "필압과 보정이 적용되는 자유선을 그립니다. 선택한 뒤 다시 누르면 브러시 설정을 열 수 있어요.")}
                {...penHintPreviewProps}
                hintShortcut="B"
                active={penModeActive}
                disabled={activeSurfaceReviewLocked}
                title={activeSurfaceReviewLocked ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "편집 잠금을 해제한 뒤 펜을 사용할 수 있어요") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "펜 (B)")}
                onClick={() => {
                  setWorkspaceDockExpanded(false);
                  if (penModeActive) {
              ...
              <StudioDockButton
                ...
                hintDescription={pixelModeActive
                  ? drawSettingsOpen
                    ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "픽셀 펜 설정을 닫고 1px 도트 작업으로 돌아갑니다.")
                    : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "픽셀 펜은 유지하고 색과 불투명도 설정을 엽니다.")
                  : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "안티앨리어싱·필압·선 보정 없이 격자에 1px 하드 픽셀을 찍습니다.")}
                hintPreview="pixel-ink"
                hintShortcut="P"
                active={pixelModeActive}
                disabled={activeSurfaceReviewLocked}
                title={activeSurfaceReviewLocked ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "편집 잠금을 해제한 뒤 픽셀 펜을 사용할 수 있어요") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "픽셀 펜 (P)")}
                onClick={() => {
                  setWorkspaceDockExpanded(false);
                  if (pixelModeActive) {
              ...
              <StudioDockButton
                ...
                hintDescription={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "현재 레이어의 획을 지웁니다. 브러시 크기와 불투명도 설정을 그대로 활용합니다.")}
                hintShortcut="E"
                active={tool === "draw" && drawMode === "eraser"}
                disabled={activeSurfaceReviewLocked}
                title={activeSurfaceReviewLocked ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "편집 잠금을 해제한 뒤 지우개를 사용할 수 있어요") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "지우개 (E)")}
                onClick={() => {
                  setWorkspaceDockExpanded(false);
              ...
              <StudioDockButton
                ...
                hintDescription={advancedFillUnsupportedReason
                  ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 눌러서 안전한 단일 래스터 후보를 찾거나 필요한 조건을 확인하세요."), { v0: String(advancedFillUnsupportedReason) })
                  : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "래스터의 닫힌 영역을 탭해 색을 채웁니다. 경계와 참조 범위는 채우기 속성에서 조절합니다.")}
                hintShortcut="G"
                active={advancedFillActive}
                title={advancedFillUnsupportedReason
                  ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "{v0} 눌러서 사용할 수 있는 래스터를 찾거나 조건을 확인하세요."), { v0: String(advancedFillUnsupportedReason) })
                  : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "채우기 (G)")}
                onClick={() => {
                  setWorkspaceDockExpanded(false);
                  setMenu(null);
                  setMobileSheet(null);
              ...
              <StudioDockButton
                ...
                hintDescription={shapeModeActive
                  ? drawSettingsOpen
                    ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "열려 있는 도형 설정을 닫고 캔버스로 돌아가 현재 도형을 계속 배치합니다.")
                    : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "도형 모드는 유지하고 설정을 열어 종류·채우기·선 굵기를 조절합니다.")
                  : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "선·사각형·타원·화살표를 정돈된 벡터 도형으로 빠르게 배치합니다.")}
                {...shapeHintPreviewProps}
                active={shapeModeActive}
                disabled={activeSurfaceReviewLocked}
                title={activeSurfaceReviewLocked ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "편집 잠금을 해제한 뒤 도형을 사용할 수 있어요") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "도형")}
                onClick={() => {
                  setWorkspaceDockExpanded(false);
                  if (shapeModeActive) {
                    setMobileSheet((s) => (s === "draw" ? null : "draw"));
              ...
              <StudioDockButton
                ...
                hintDescription={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "마지막 편집을 한 단계 되돌립니다. 공동 작업 변경 이력과 함께 안전하게 이동합니다.")}
                hintUnavailableReason={undoDisabled ? undoUnavailableTitle : undefined}
                disabled={undoDisabled}
                title={undoDisabled ? undoUnavailableTitle : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "실행취소")}
                onClick={() => {
                  setWorkspaceDockExpanded(false);
                  undo();
                }}
              ...
              <StudioDockButton
                ...
                hintDescription={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "되돌린 편집을 한 단계 다시 적용합니다.")}
                hintUnavailableReason={redoDisabled ? redoUnavailableTitle : undefined}
                disabled={redoDisabled}
                title={redoDisabled ? redoUnavailableTitle : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "다시실행")}
                onClick={() => {
                  setWorkspaceDockExpanded(false);
                  redo();
                }}
              ...
              <StudioDockButton
                icon={Files}
                label={label.pages}
                hintDescription={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "페이지 목록을 열어 추가·복제·순서를 바꿉니다.")}
              ...
              {handleDownload ? (
                <StudioDockButton
                  icon={Download}
                  label={label.export}
                  hintDescription={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "현재 페이지를 선택한 배율과 이미지 형식으로 즉시 내보냅니다.")}
              ...
              <StudioDockButton
                ...
                hintDescription={drawSettingsOpen
                  ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "열려 있는 브러시 설정을 닫고 캔버스로 돌아갑니다.")
                  : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "브러시 설정을 열어 굵기·불투명도·색·보정·프리셋을 한곳에서 조절합니다.")}
                hintPreview="draw-settings"
                hintPreviewVariant={drawSettingsOpen ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "collapse") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "expand")}
              ...
              />
                ...
                <StudioMobileScrollCues
                  descriptionId={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "{v0}-primary"), { v0: String(scrollDescriptionId) })}
                  placement="primary"
                />
              </div>
              ...
              <button
                ...
                title={workspaceDockExpanded
                  ...
                  : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "댓글·페이지·필터·새 작업·작업 패널·색각·줌 도구 펼치기")}
            ...
            <div
              ...
              aria-describedby={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "{v0}-secondary"), { v0: String(scrollDescriptionId) })}
              data-studio-mobile-control-side={mobileControlSide}
            >
              <StudioDockNavButton
                icon={commentPinArmed ? X : MessageCircle}
                label={commentPinArmed ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "취소") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "댓글")}
                active={commentPinArmed}
                aria-pressed={commentPinArmed}
                aria-label={commentPinArmed ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "댓글 위치 선택 취소") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "캔버스 위치 댓글")}
                title={commentPinArmed ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "댓글 위치 선택 취소") : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "캔버스 위치 댓글")}
              ...
              >
                ...
                <StudioDockNavButton
                  icon={Layers}
                  label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "작업 패널")}
                  aria-label={
                    translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "작업 패널")
                  }
                  title={
                    mobileSheet === "props"
                      ? translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "작업 패널 닫기")
                      : translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "작업 패널 열기 · 대상·레이어·문서")
                  }
                ...
                */}
                ...
                <StudioDockNavButton
                  icon={WandSparkles}
                  label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "새 작업")}
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "빠른 시작 · 새 작업 열기")}
                  aria-haspopup="dialog"
                  title={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "템플릿과 웹툰 마법사로 새 작업 시작")}
                  onClick={() => {
                    setMobileSheet(null);
                ...
                <StudioDockNavButton
                  icon={Palette}
                  label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "색각")}
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "색각·명암 검수")}
                ...
                <div className="flex w-[8.25rem] flex-none items-center justify-center">
                  <button
                    ...
                    aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "축소")}
                  >
                  ...
                  <button
                    ...
                    aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "화면 폭에 맞춤")}
                  >
                    {Math.round(zoom * 100)}%
                  </button>
                  <button
                    ...
                    className="grid size-11 place-items-center rounded-lg text-fg-2 transition-colors hover:bg-raised disabled:opacity-40"
                    aria-label={translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "ko", "확대")}
                  >
                ...
                <StudioMobileScrollCues
                  descriptionId={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioMobileEditingDock", "en", "{v0}-secondary"), { v0: String(scrollDescriptionId) })}
                  placement="secondary"
                />
              </div>
