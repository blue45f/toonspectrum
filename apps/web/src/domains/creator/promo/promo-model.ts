...
export const PROMO_MOTIONS = ["push-in", "pull-out", "pan-left", "pan-right", "pan-up", "still", "pan-down", "diagonal-reveal", "arc-left", "arc-right", "breathing", "impact-settle", "drift", "orbit", "impact", "float"] as const;
...
export const PROMO_MOTION_LABELS: Record<PromoMotion, string> = {
  ...
  drift: "대각선 드리프트", orbit: "완만한 원형 이동",
