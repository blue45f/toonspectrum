...
export const STUDIO_VIEW_ACTION_HINTS = {
  zoomOut: {
    ...
    title: "축소",
    description:
      "캔버스 보기 배율을 한 단계 축소해 더 넓은 작업 범위를 확인합니다.",
    shortcut: "−",
    preview: "zoom-view",
  ...
  zoomIn: {
    ...
    title: "확대",
    description:
      "캔버스 보기 배율을 한 단계 확대해 선과 픽셀의 세부를 확인합니다.",
    shortcut: "=",
    preview: "zoom-view",
  ...
  actualSize: {
    ...
    title: "실제 픽셀 100%",
    description:
      "화면의 CSS 1px에 문서 1px이 대응하도록 맞춰 선명도와 픽셀 경계를 왜곡 없이 확인합니다.",
    shortcut: "End",
    preview: "zoom-view",
  ...
  fitWidth: {
    ...
    title: "너비에 맞춤",
    description:
      "현재 작업 영역의 가로 폭에 캔버스가 들어오도록 보기 배율을 자동 계산합니다.",
    shortcut: "Home",
    preview: "zoom-view",
  ...
  fitSelection: {
    ...
    title: "선택 영역에 맞춤",
    description:
      "선택한 요소 전체가 작업 영역에 들어오도록 확대율과 스크롤 위치를 함께 맞춥니다.",
    tip: "작은 소품이나 여러 컷을 선택한 뒤 즉시 집중 검토할 때 사용하세요.",
  },
  reset: {
    id: "view:reset",
    title: "보기 초기화",
    description:
      "배율·회전·좌우 반전과 스크롤 위치를 기본 보기로 되돌립니다. 원고 데이터와 내보내기 결과는 바뀌지 않습니다.",
    preview: "zoom-view",
  ...
  rotateLeft: {
    ...
    title: "왼쪽으로 90° 회전",
    description:
      "캔버스 보기만 반시계 방향으로 90° 돌립니다. 원고 좌표와 내보내기 방향은 유지됩니다.",
    preview: "rotate-view",
  ...
  rotateRight: {
    ...
    title: "오른쪽으로 90° 회전",
    description:
      "캔버스 보기만 시계 방향으로 90° 돌립니다. 원고 좌표와 내보내기 방향은 유지됩니다.",
    preview: "rotate-view",
  ...
  flip: {
    ...
    title: "좌우 반전",
    description:
      "그림의 균형을 점검할 수 있도록 캔버스 보기만 거울처럼 뒤집습니다. 원고 픽셀은 변경하지 않습니다.",
    preview: "flip-view",
    previewVariant: "flip",
  ...
  restoreFlip: {
    ...
    title: "좌우 반전 해제",
    description:
      "거울 보기를 해제하고 캔버스를 원래 좌우 방향으로 복원합니다. 원고 픽셀은 변경하지 않습니다.",
    preview: "flip-view",
  ...
  close: {
    ...
    title: "보기 도구 닫기",
    description:
      "현재 확대·축소 또는 회전 HUD를 닫고 호출한 보기 도구로 포커스를 돌려보냅니다. 호출 도구가 없으면 캔버스로 이동하며 적용한 보기 상태는 유지됩니다.",
    shortcut: "Esc",
    preview: "dismiss",
  },
...
export function studioViewFlipHint(flipped: boolean): StudioToolHintSpec {
  return flipped
    ? STUDIO_VIEW_ACTION_HINTS.restoreFlip
    : STUDIO_VIEW_ACTION_HINTS.flip;
}
