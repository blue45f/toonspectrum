...
export function StudioMannequinBodySection({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3 pt-3 border-t border-line/60">
        <StudioSectionHeader
          title={translateCurrentStaticSourceText("domains.creator.scene.3d.StudioMannequinPoserPanel", "ko", "3D 헤드 모델 (Face Proportions)")}
          description={translateCurrentStaticSourceText("domains.creator.scene.3d.StudioMannequinPoserPanel", "ko", "CSP 2.0 3D 헤드 모델: 웹툰/애니형, 턱선, 눈, 코 비율을 조절합니다.")}
        />
