...
export const STUDIO_MENU_GROUP_SPEC: readonly StudioMenuGroupSpec[] = Object.freeze([
  ...
  },
  {
    ...
    rows: [
      ...
      part(
        "웹툰 세로 캔버스",
        "현재 드로잉에서 네이버·카카오·WEBTOON Canvas·1080 고화질 비율을 단일 Undo 커밋으로 적용하고 플랫폼 폭 가이드를 직접 켠다.",
  ...
  },
  {
    ...
    rows: [
      ...
      gap("Font Report", "사용자 폰트 관리는 텍스트 인스펙터에 연결되어 있으나 폰트 사용·라이선스 보고서는 아직 없다."),
    ],
    extras: [],
  },
  {
    ...
    extras: [
      ...
      ours("comic/ai-super-suite", "AI와 스마트 제작 도구"),
    ],
  },
  {
    id: "animation",
