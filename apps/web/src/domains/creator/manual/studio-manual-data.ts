...
export const MANUAL_ARTICLES: readonly ManualArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "help", title: "원하는 기능 찾기", paragraphs: ["도움말의 명령·속성 통합 검색(F1)에서 기능 이름을 찾습니다. 다른 프로그램의 이름이 익숙하다면 다른 앱 용어 찾기를 사용하세요.", "작업을 보면서 매뉴얼을 읽으려면 도움말의 사용자 매뉴얼을 엽니다. 새 탭으로 열리므로 기존 편집 탭은 그대로 남습니다."] },
    ],
  },
  {
