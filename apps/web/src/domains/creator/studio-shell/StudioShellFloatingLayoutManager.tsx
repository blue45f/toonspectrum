  ...
  return (
    <>
      ...
      <div
        ...
        data-studio-shell-drawing-auto-hide-active={drawingAutoHideRunning ? translateCurrentStaticSourceText("domains.creator.studio.shell.StudioShellFloatingLayoutManager", "en", "true") : translateCurrentStaticSourceText("domains.creator.studio.shell.StudioShellFloatingLayoutManager", "en", "false")}
      ...
      >
        {open ? (
          <div
            ...
            role="dialog"
            aria-modal="false"
            aria-label={translateCurrentStaticSourceText("domains.creator.studio.shell.StudioShellFloatingLayoutManager", "ko", "보기 및 플로팅 UI 설정")}
          ...
          >
            <header className="flex items-start gap-3 border-b border-line p-4">
              ...
              <div className="min-w-0 flex-1">
                <h2 className="text-sm font-black">{translateCurrentStaticSourceText("domains.creator.studio.shell.StudioShellFloatingLayoutManager", "ko", "보기 · 플로팅 UI")}</h2>
              ...
              <button
                type="button"
                aria-label={translateCurrentStaticSourceText("domains.creator.studio.shell.StudioShellFloatingLayoutManager", "ko", "보기 설정 닫기")}
