...
describe("consolidated Studio brush product portfolio", () => {
  it("keeps 95 quality representatives first inside the complete selectable catalogue", () => {
    expect(STUDIO_BRUSH_QUALITY_PORTFOLIO).toHaveLength(95);
    expect(new Set(STUDIO_BRUSH_QUALITY_PORTFOLIO_IDS).size).toBe(95);
    ...
    expect(STUDIO_DEFAULT_QUALITY_PAINT_BRUSH_CATALOG_ITEMS).toHaveLength(93);
