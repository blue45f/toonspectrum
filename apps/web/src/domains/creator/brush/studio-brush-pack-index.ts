...
const DESCRIPTOR_ROWS: readonly DescriptorRow[] = [
  ...
  ["방향성 평붓", "방향 평붓", "진행 방향을 따라 납작한 자국을 잇는 평면 촉", "flat", 32, 0.8, "dry-media", "texture", 0.8],
  ...
  ["거친 잉크", "거친 잉크", "마른 공극과 짙은 중심이 공존하는 텍스처 잉크", "ink", 16, 0.86, "dry-media", "texture", 0.58],
  ...
  ["유화 면붓", "유화 면붓", "기울기와 필압으로 폭이 바뀌는 단색 유화 면을 연속해서 칠하는 붓", "paint", 31, 0.9, "dry-media", "oil", 0.82],
  ...
  ["촘촘한 유화 붓결", "밀집 붓결", "촘촘한 강모를 진하게 겹쳐 칠하는 평면 유화 질감 촉", "paint", 26, 0.95, "ink-particle", "oil", 0.78],
  ...
  ["소금 결정 얼룩", "소금 결정", "결정 모양의 밝은 틈과 방사 무늬를 반투명하게 겹쳐 찍는 효과 촉", "paint", 38, 0.42, "airbrush", "glitter", 0.88],
  ["불규칙 얼룩 고리", "얼룩 고리", "가장자리가 진하고 중심이 빈 불규칙 고리 자국을 찍는 촉", "paint", 46, 0.38, "airbrush", "soft", 0.92],
