...
describe("procedural brush pack ids", () => {
  it("publishes exactly 192 stable, unique catalogue ids", () => {
    expect(STUDIO_BRUSH_PACK_CATALOG_IDS).toHaveLength(192);
    expect(new Set(STUDIO_BRUSH_PACK_CATALOG_IDS).size).toBe(192);
