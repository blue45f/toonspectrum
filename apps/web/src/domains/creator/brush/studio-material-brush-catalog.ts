...
export const STUDIO_MATERIAL_BRUSH_DEFINITIONS = [
  ...
  {"program": "gouache-craquelure", "name": "과슈 균열 판면", "shortName": "과슈 균열", "hint": "조밀한 불투명 판면과 가는 마른 균열을 남기는 재질 팁", "category": "paint", "width": 38, "opacity": 0.9, "runtime": "dry-media", "preview": "texture", "mode": "continuous", "spacing": 0.16, "flow": 0.42, "scatter": 0.02, "roundness": 1, "tiltRatio": 0.68},
