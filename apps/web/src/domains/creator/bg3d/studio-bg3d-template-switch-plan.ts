...
/**
 * Converts the legacy "append another catalog template" behavior into a single active catalog
 * template slot. User-authored primitives/models remain untouched. Existing catalog instances are
 * removed together so old scenes that accumulated multiple templates recover on the next switch.
 *
