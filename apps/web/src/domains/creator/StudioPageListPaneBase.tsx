  ...
  return (
    <>
      <div
        ...
        title={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "{v0} · 현재 {v1}px · 드래그 / 더블클릭·더블탭·Enter(기본) / ←→"), { v0: String(label), v1: String(handleProps["aria-valuenow"]) })}
        data-studio-panel-resizer="true"
        data-dragging={dragging ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "true") : translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "false")}
        className={cn(
      ...
      <span id={helpId} className="sr-only">
        {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "좌우 방향키로 조금씩 조절하고 Home과 End로 최소·최대 너비를 선택할 수 있습니다. Enter를 누르거나 더블클릭·더블탭하면 기본 너비로 돌아갑니다.")}</span>
    </>
  );
}
    ...
    <>
      {!visibleLeftPanelOpen && !presentationPanelsHidden && (
        <StudioEdgeRailButton
          side="left"
          label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지")}
          icon={LayoutTemplate}
          onClick={() => setLeftPanelOpen(true)}
          title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 목록 펼치기")}
        />
      )}
      <StudioDetachablePanelSlot
        detached={desktopDetached && visibleLeftPanelOpen}
        surfaceId="page-list"
        label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 목록")}
      ...
      >
        <div
          ...
          ref={pagesSheetRef}
          role={isMobile && mobileSheet === "pages" ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "dialog") : undefined}
          aria-modal={isMobile && mobileSheet === "pages" ? true : undefined}
          data-studio-sheet-id="pages"
          data-studio-panel-detached={desktopDetached ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "true") : undefined}
          data-studio-ui-preferences-authority={preferenceAuthority}
          data-studio-mobile-sheet={isMobile && mobileSheet === "pages" ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "true") : undefined}
          data-studio-sheet-snap={isMobile ? mobileSnap : undefined}
          data-popup-kind={isMobile && mobileSheet === "pages" ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "sheet") : undefined}
          aria-label={isMobile && mobileSheet === "pages" ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 목록") : undefined}
        ...
        >
          <div className="shrink-0 border-b border-line/50 pb-1.5">
            {isMobile ? (
              <Suspense fallback={<div aria-hidden className="min-h-11" />}>
                <LazyStudioMobileSheetHandle
                  ...
                  kind="pages"
                  label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 시트")}
            ...
            <div className="flex min-h-11 flex-wrap items-center justify-between gap-2">
              <span className="flex shrink-0 items-center gap-1 text-[0.7rem] font-bold text-fg-2">
                <button
                  ...
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 목록 접기")}
                  title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 목록 접기")}
                >
                  <ChevronLeft size={13} />
                </button>
                {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지")}<span className="font-normal tabular-nums text-fg-3">
              ...
              <div className="flex shrink-0 items-center gap-1">
                {!isMobile ? (
                  <button
                    ...
                    aria-label={detached
                      ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 목록을 왼쪽 패널에 붙이기")
                      : translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 목록을 창으로 분리")}
                    aria-pressed={desktopDetached}
                    title={detached ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "왼쪽 패널에 붙이기") : translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "자유 배치 창으로 분리")}
                ...
                <button
                  ...
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 시트 닫기")}
                  data-autofocus
                >
                ...
                <button
                  ...
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "새 페이지 추가")}
                  title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "새 페이지 추가")}
                  onClick={addPage}
                ...
                >
                  <Plus size={12} aria-hidden /> {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 추가")}</button>
              </div>
            </div>

            <div
              role="search"
              aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 검색 및 필터")}
            ...
            >
              <div className="relative min-w-[10rem] flex-1">
                ...
                <input
                  ...
                  value={pageQuery}
                  maxLength={200}
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 검색")}
                  ...
                  placeholder={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이름·메모·태그·담당자 검색")}
                  title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 검색 · / 키로 포커스")}
                ...
                {pageQuery ? (
                  <button
                    ...
                    aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 검색어 지우기")}
              ...
              <label className="relative flex min-h-11 min-w-[7rem] items-center rounded-lg border border-line bg-card pl-8 text-fg-2 focus-within:border-accent focus-within:ring-1 focus-within:ring-accent/30">
                ...
                />
                <span className="sr-only">{translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 필터")}</span>
                <select
                  value={pageFilter}
                  onChange={(event) => setPageFilter(event.currentTarget.value as StudioPageListFilter)}
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 필터")}
              ...
              <button
                ...
                aria-label={autoFollowCurrent
                  ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "현재 페이지 자동 추적 끄기")
                  : translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "현재 페이지 자동 추적 켜기")}
                aria-pressed={autoFollowCurrent}
                title={autoFollowCurrent
                  ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "현재 페이지를 목록 안에 자동으로 유지")
                  : translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "현재 페이지 자동 추적 꺼짐")}
                className={cn(
            ...
            <span id={navigationHelpId} className="sr-only">
              {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "검색은 페이지 이름, 번호, 콘티 메모, 샷 태그, 검토 상태와 담당자를 함께 찾습니다. 페이지 카드에서 방향키, Home, End, Page Up, Page Down으로 이동하고 Shift를 함께 눌러 연속 선택할 수 있습니다. Control 또는 Command+A는 현재 표시 결과를 모두 선택합니다.")}</span>
            <div className="mt-1 flex min-h-8 flex-wrap items-center gap-1 text-[0.65rem] text-fg-3">
              <span aria-live="polite" aria-atomic="true" className="mr-auto tabular-nums">
                {navigationEntries.length}{translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "개 표시")}{hiddenSelectedPageCount > 0 ? formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", " · 선택 {v0}개 숨김"), { v0: String(hiddenSelectedPageCount) }) : ""}
                {!currentPageVisible && navigationActive ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", " · 현재 페이지 숨김") : ""}
              </span>
              <button
                type="button"
              ...
              >
                {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "표시 전체 선택")}</button>
              {liveSelectedPageIds.length > 0 ? (
                ...
                >
                  {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "선택 해제")}</button>
              ) : null}
              {!currentPageVisible && navigationActive ? (
                <button
                  ...
                  className="min-h-8 rounded-md px-2 font-semibold text-fg-2 hover:bg-raised"
                >
                  {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "현재 페이지 보기")}</button>
              ) : null}
              {navigationActive ? (
                <button
                  type="button"
                ...
                >
                  {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "검색·필터 초기화")}</button>
              ) : null}
            </div>
            {navigationActive ? (
              <p className="mt-1 rounded-md border border-line/70 bg-raised/40 px-2 py-1 text-[0.62rem] leading-snug text-fg-3">
                {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "검색·필터 중에는 숨은 페이지 사이로 잘못 놓이지 않도록 드래그 정렬을 잠급니다. 순서 변경 버튼과 일괄 이동은 전체 문서 순서를 기준으로 계속 동작합니다.")}</p>
            ) : null}

            <div
              role="toolbar"
              aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 일괄 작업")}
            ...
            >
              <button
                ...
                title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "현재 페이지의 색보정을 모든 페이지에 적용")}
              >
                {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "색보정 전체 적용")}</button>
              <button
                type="button"
                onClick={applyBgToAll}
                className="min-h-11 min-w-11 shrink-0 rounded-lg border border-line px-3 text-[0.7rem] text-fg-3 hover:bg-raised lg:px-1.5 lg:text-[10px]"
                title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "현재 페이지의 배경을 모든 페이지에 적용")}
              >
                {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "배경 전체")}</button>
              <button
                type="button"
                ...
                title={collaborationDocumentLocked
                  ? collaborationLockMessage()
                  : translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "마스터 페이지(모든 페이지 공통 요소) 관리")}
              >
                {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "마스터")}{master.elements.length > 0 ? ` ${master.elements.length}` : ""}
              </button>
              <div
                role="group"
                aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 미리보기 크기")}
                className="ml-auto flex min-h-11 shrink-0 items-center gap-1 rounded-lg border border-line bg-card px-1.5"
                title={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 미리보기 {v0}"), { v0: String(PAGE_PREVIEW_SIZE_LABEL[pagePreviewSize]) })}
              >
                ...
                <input
                  ...
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 미리보기 크기 조절")}
            ...
            {preferenceAuthority === "memory-only" ? (
              <p role="status" className="mt-1 rounded-md border border-warning/40 bg-warning/10 px-2 py-1 text-[0.62rem] text-fg-2">
                {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "미리보기 크기는 저장소를 다시 연결하기 전까지 이번 탭에서만 유지됩니다.")}</p>
            ) : null}
            {multiSelectActive ? (
              <div
                role="toolbar"
                aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "선택한 페이지 일괄 작업")}
              ...
              >
                <span className="shrink-0 px-1.5 text-[0.7rem] font-bold tabular-nums text-accent lg:text-[10px]">
                  {liveSelectedPageIds.length}{translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "개 선택")}</span>
                <button
                  type="button"
                  ...
                  title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "선택한 페이지 위로 이동")}
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "선택한 페이지 위로 이동")}
                >
                ...
                <button
                  ...
                  onClick={() => movePagesBulk(liveSelectedPageIds, 1)}
                  className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-2 hover:bg-raised lg:rounded-lg lg:px-1.5"
                  title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "선택한 페이지 아래로 이동")}
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "선택한 페이지 아래로 이동")}
                >
                ...
                <button
                  ...
                  title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "선택한 페이지 삭제")}
                  aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "선택한 페이지 삭제")}
                >
          ...
          <div
            ...
            aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 검색 결과")}
            aria-busy={pageQuery !== deferredPageQuery}
            data-studio-page-navigation-active={navigationActive ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "true") : undefined}
            ...
            {navigationEntries.length === 0 ? (
              ...
              >
                <div>
                  ...
                  <p className="text-sm font-bold text-fg-2">{translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "조건에 맞는 페이지가 없습니다")}</p>
                  <p className="mt-1 text-xs leading-relaxed text-fg-3">
                    {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이름, 번호, 콘티 메모, 샷 태그, 검토 상태와 담당자를 검색할 수 있습니다.")}</p>
                  <button
                    type="button"
                    onClick={clearNavigation}
              ...
              return (
                <div
                  ...
                  data-selected={isMultiSelected ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "true") : undefined}
                  {...(dndProps ?? { draggable: false })}
                  title={navigationActive
                    ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "검색·필터 중에는 드래그 정렬이 잠깁니다 · Shift/⌘/Ctrl+클릭으로 다중 선택")
                    : translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "드래그하여 순서 변경 · Shift 연속 선택 · ⌘/Ctrl+클릭 개별 선택 · 더블클릭 이름 편집")}
                  className={cn(
                ...
                >
                  <button
                    ...
                    aria-label={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "{v0} 선택"), { v0: String(displayName) })}
                    aria-pressed={isActive || isMultiSelected}
                    aria-current={isActive ? translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "page") : undefined}
                    aria-describedby={navigationHelpId}
                  ...
                  <div className="flex min-w-0 flex-wrap items-center justify-between gap-1">
                    ...
                    {review.status !== "draft" ? (
                      <span
                        data-testid={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "en", "studio-page-review-{v0}"), { v0: String(p.id) })}
                        className={cn(
                    ...
                    {review.locked ? (
                      <span
                        ...
                        title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "검토 잠금")}
                        aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "검토 잠금")}
                      >
                    ...
                    <div className="relative z-20 flex max-w-[70%] items-center gap-0.5 overflow-x-auto overscroll-x-contain [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:max-w-none lg:flex-wrap lg:justify-end lg:overflow-visible">
                      <button
                        ...
                        title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이름·콘티 메모 편집")}
                        aria-label={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "{v0} 이름·콘티 메모 편집"), { v0: String(displayName) })}
                      ...
                      <button
                        ...
                        title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "위로 이동")}
                        aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "위로 이동")}
                      >
                        <ChevronUp size={14} aria-hidden />
                      </button>
                      <button
                        ...
                        className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-3 hover:bg-raised disabled:opacity-30 lg:rounded"
                        title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "아래로 이동")}
                        aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "아래로 이동")}
                      >
                        <ChevronDown size={14} aria-hidden />
                      </button>
                      <button
                        ...
                        disabled={idx === 0}
                        className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-3 hover:bg-raised disabled:opacity-30 lg:rounded"
                        title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "맨 위로")}
                        aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "맨 위로 이동")}
                      >
                      ...
                      <button
                        ...
                        disabled={idx === pages.length - 1}
                        className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-3 hover:bg-raised disabled:opacity-30 lg:rounded"
                        title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "맨 아래로")}
                        aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "맨 아래로 이동")}
                      >
                        <span aria-hidden="true" className="text-sm leading-none lg:text-[10px]">⇩</span>
                      </button>
                    </div>
                  ...
                  {metaEditPageId === p.id ? (
                    <div className="relative z-20 flex flex-col gap-1 pt-1">
                      <input
                        ...
                        aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 이름")}
                      ...
                      <textarea
                        rows={2}
                        defaultValue={p.note ?? ""}
                        placeholder={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "콘티 메모 (장면·대사 아이디어)")}
                        maxLength={PAGE_NOTE_MAX}
                        spellCheck
                        aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "콘티 메모")}
                      ...
                      >
                        {translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "완료")}</button>
                    </div>
                  ) : p.note ? (
                  ...
                  <div className="relative z-20 flex items-center justify-start gap-1 overflow-x-auto overscroll-x-contain pt-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:flex-wrap lg:justify-end lg:overflow-visible">
                    <button
                      ...
                      title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이 앞에 빈 페이지 삽입")}
                      aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이 앞에 빈 페이지 삽입")}
                    >
                    ...
                    <button
                      ...
                      className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-3 hover:bg-raised lg:rounded"
                      title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이 뒤에 빈 페이지 삽입")}
                      aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이 뒤에 빈 페이지 삽입")}
                    >
                      <Plus size={14} aria-hidden />
                    </button>
                    <button
                      ...
                      className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-3 hover:bg-raised lg:rounded"
                      title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 복제")}
                      aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 복제")}
                    >
                    ...
                    <button
                      ...
                      className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-3 hover:bg-raised lg:rounded"
                      title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "미러 복제 (좌우 반전)")}
                      aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "미러 복제 (좌우 반전)")}
                    >
                    ...
                    <button
                      ...
                      className="grid size-11 shrink-0 place-items-center rounded-xl text-fg-3 hover:bg-raised lg:rounded"
                      title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이 페이지 내용 비우기")}
                      aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "이 페이지 내용 비우기")}
                    >
                    ...
                    <button
                      ...
                      title={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 삭제")}
                      aria-label={translateCurrentStaticSourceText("domains.creator.StudioPageListPaneBase", "ko", "페이지 삭제")}
                    >
                      <Trash2 size={14} aria-hidden />
                    </button>
                  </div>
