...
export const STUDIO_CONTEXT_HELP_GUIDES = [
  ...
  },
  {
    ...
    eyebrow: "탐색",
    title: "캔버스를 빠르게 이동하기",
    summary: "일반 마우스에서도 휠은 세로, Shift+휠은 가로로 이동하고 스페이스·드래그나 휠 버튼·드래그로 자유롭게 화면을 옮길 수 있습니다.",
    outcome: "그리기 흐름을 끊지 않고 세로 웹툰과 넓은 작업 영역을 빠르게 탐색할 수 있습니다.",
    steps: [
      { title: "세로·가로 이동", body: "휠로 위아래를 이동하고, 좌우로 이동할 때는 Shift를 누른 채 휠을 굴립니다." },
      { title: "자유 이동", body: "스페이스를 누른 채 캔버스를 드래그하거나, 이동으로 설정된 휠 버튼을 누른 채 원하는 방향으로 드래그합니다." },
      { title: "전체 위치 확인", body: "필요할 때 맞춤 보기를 사용해 캔버스에서 현재 위치를 다시 확인합니다." },
    ],
    tips: ["휠 동작이 브러시 크기인 경우 Shift+휠은 5px 크기 조절을 유지합니다. 이때는 스페이스·드래그나 휠 버튼·드래그로 이동하세요."],
    troubleshooting: [{ symptom: "캔버스 대신 객체가 움직임", resolution: "스페이스를 먼저 누르거나 휠 버튼을 누른 상태에서 드래그하고, 마우스 설정의 휠 버튼 동작이 이동인지 확인합니다." }],
