...
export function StudioOfflinePanel() {
  ...
  return (
    <aside
      ...
      aria-label={translateCurrentStaticSourceText("domains.creator.offline.StudioOfflinePanel", "ko", "스튜디오 연결 및 오프라인 작업 안내")}
      data-studio-shell-floating-target="offline-readiness"
      data-studio-shell-force-visible={attentionRequired ? translateCurrentStaticSourceText("domains.creator.offline.StudioOfflinePanel", "en", "true") : undefined}
    >
      <details
