...
export const STUDIO_RAIL_TOOL_CATALOG = [
  ...
  { id: "mannequin3d", label: "기본 데생 인형", labelKey: "studio.settings.tool.mannequin", defaultShortcut: "" },
  { id: "vrm3d", label: "인물·포즈 편집", labelKey: "studio.settings.tool.vrm3d", defaultShortcut: "" },
  { id: "character-shaper", label: "캐릭터 만들기", labelKey: "studio.settings.tool.characterShaper", defaultShortcut: "" },
  { id: "bg3d", label: "장면 도우미", labelKey: "studio.settings.tool.bg3d", defaultShortcut: "" },
