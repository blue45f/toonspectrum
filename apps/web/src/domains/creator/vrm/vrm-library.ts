...
export const SAMPLE_VRMS: SampleVrm[] = [
  { id: SAMPLE_VRM_ID, name: "루미", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/sample-vrm.png", url: SAMPLE_VRM_URL },
  ...QUATERNIUS_FANTASY_VRMS,
  ...QUATERNIUS_MODULAR_VRMS,
  { id: "avatar-a", name: "하린", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/avatar-a.png", url: "/vrm/AvatarSample_A.vrm" },
  { id: "avatar-b", name: "세라", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/avatar-b.png", url: "/vrm/AvatarSample_B.vrm" },
  { id: "avatar-c", name: "유나", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/avatar-c.png", url: "/vrm/AvatarSample_C.vrm" },
  { id: "shion", name: "시온", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/shion.png", url: "/vrm/Sendagaya_Shibu.vrm" },
  { id: "vivi", name: "비비", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v1/vivi.png", url: "/vrm/Vivi.vrm" },
  { id: "vita", name: "비타", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/vita.png", url: "/vrm/Vita.vrm" },
  { id: "rubin", name: "루빈", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v1/rubin.png", url: "/vrm/Victoria_Rubin.vrm" },
  { id: "orion", name: "오리온 (로봇)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/orion.png", url: "/vrm/Avatar_Orion.vrm" },
  {
    id: "cryptovoxel",
    name: "크립토 (복셀봇)",
    thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cryptovoxel.png",
    url: "/vrm/cryptovoxels.vrm",
    visibility: "legacy",
    limitations: ["no-expressions"],
  },
  { id: "seedsan", name: "시드상 (마스코트)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/seedsan.png", url: "/vrm/Seed_san.vrm" },
  { id: "shino", name: "시노", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/shino.png", url: "/vrm/Sendagaya_Shino.vrm" },
  {
    id: "fumi",
    name: "후미",
    thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/fumi.png",
  ...
  { id: "mio", name: "미오 (인체 베이스)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/mio.png", url: "/vrm/fem_vroid.vrm" },
  { id: "noa", name: "노아 (인체 베이스)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/noa.png", url: "/vrm/masc_vroid.vrm" },
  { id: "alicia", name: "아리시아", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v1/alicia.png", url: "/vrm/AliciaSolid.vrm" },
  { id: "devil", name: "데빌 (악마)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/devil.png", url: "/vrm/Devil.vrm" },
  { id: "polydancer", name: "폴리댄서", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/polydancer.png", url: "/vrm/Polydancer.vrm" },
  { id: "rose", name: "로즈", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/rose.png", url: "/vrm/Rose.vrm" },
  { id: "robert", name: "로버트", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/robert.png", url: "/vrm/Robert.vrm" },
  { id: "bloody", name: "블러디 (빌런)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/bloody.png", url: "/vrm/Bloody.vrm" },
  { id: "rabbit", name: "래빗 (토끼)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/rabbit.png", url: "/vrm/Rabbit.vrm" },
  { id: "eggplant", name: "에그플랜트 (가지)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/eggplant.png", url: "/vrm/Eggplant.vrm" },
  { id: "coolbanana", name: "쿨바나나", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/coolbanana.png", url: "/vrm/CoolBanana.vrm" },
  ...
  { id: "wizzir", name: "위지르 (마법사)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/wizzir.png", url: "/vrm/Wizzir.vrm" },
  { id: "clown", name: "클라운 (광대)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/clown.png", url: "/vrm/Clown.vrm" },
  { id: "wolfman", name: "울프맨 (늑대인간)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/wolfman.png", url: "/vrm/Wolfman.vrm" },
  { id: "mummy", name: "머미 (미라)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/mummy.png", url: "/vrm/Mummy.vrm" },
  { id: "kate", name: "케이트", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/kate.png", url: "/vrm/Kate.vrm" },
  { id: "witch", name: "위치 (마녀)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/witch.png", url: "/vrm/Witch.vrm" },
  { id: "dracula", name: "드라큘라 (뱀파이어)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/dracula.png", url: "/vrm/Dracula.vrm" },
  { id: "zombie", name: "좀비", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/zombie.png", url: "/vrm/Zombie.vrm" },
  { id: "dino-kid", name: "디노키드 (공룡)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/dino-kid.png", url: "/vrm/DinoKid.vrm" },
  { id: "astronaut", name: "애스트로넛 (우주비행사)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/astronaut.png", url: "/vrm/Astronaut.vrm" },
  {
    id: "polybot",
    name: "폴리봇 (로봇)",
    thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/polybot.png",
    url: "/vrm/Polybot.vrm",
    limitations: ["limited-hand-rig"],
  },
  { id: "jennifer", name: "제니퍼", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/jennifer.png", url: "/vrm/Jennifer.vrm" },
  { id: "erika", name: "에리카", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/erika.png", url: "/vrm/Erika.vrm" },
  { id: "olivia", name: "올리비아", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/olivia.png", url: "/vrm/Olivia.vrm" },
  { id: "avocado", name: "아보카도", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/avocado.png", url: "/vrm/Avocado.vrm" },
  { id: "ice-cream", name: "아이스크림", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/ice-cream.png", url: "/vrm/IceCream.vrm" },
  { id: "pyre-sorcerer", name: "파이어소서러 (화염술사)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/pyre-sorcerer.png", url: "/vrm/PyreSorcerer.vrm" },
  ...
  { id: "lalo-bot", name: "랄로봇 (로봇)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/lalo-bot.png", url: "/vrm/LaloBot.vrm" },
  { id: "shark-person", name: "샤크퍼슨 (상어)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/shark-person.png", url: "/vrm/SharkPerson.vrm" },
  { id: "chill-penguin", name: "칠펭귄 (펭귄)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/chill-penguin.png", url: "/vrm/ChillPenguin.vrm" },
  { id: "cool-turtle", name: "쿨터틀 (거북이)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cool-turtle.png", url: "/vrm/CoolTurtle.vrm" },
  { id: "moon-girl", name: "문걸 (달소녀)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/moon-girl.png", url: "/vrm/MoonGirl.vrm" },
  { id: "eye-wizard", name: "아이위저드 (외눈 마법사)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/eye-wizard.png", url: "/vrm/EyeWizard.vrm" },
  { id: "cool-pizza", name: "쿨피자", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cool-pizza.png", url: "/vrm/CoolPizza.vrm" },
  { id: "cool-ramen", name: "쿨라멘", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cool-ramen.png", url: "/vrm/CoolRamen.vrm" },
  { id: "cool-taco", name: "쿨타코", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cool-taco.png", url: "/vrm/CoolTaco.vrm" },
  { id: "cool-pirate", name: "쿨파이럿 (해적)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cool-pirate.png", url: "/vrm/CoolPirate.vrm" },
  { id: "cosmic-dweller", name: "코스믹드웰러 (우주인)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cosmic-dweller.png", url: "/vrm/CosmicDweller.vrm" },
  { id: "chill-palm", name: "칠팜 (야자수)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/chill-palm.png", url: "/vrm/ChillPalm.vrm" },
  { id: "good-knight", name: "굿나이트 (기사)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/good-knight.png", url: "/vrm/GoodKnight.vrm" },
  { id: "bad-bot", name: "배드봇 (로봇)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/bad-bot.png", url: "/vrm/BadBot.vrm" },
  {
    id: "pirate-bot",
    name: "파이럿봇 (해적 로봇)",
    thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/pirate-bot.png",
    url: "/vrm/PirateBot.vrm",
    limitations: ["heavy-payload"],
  },
  { id: "cyberpal", name: "사이버팔 (사이보그)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cyberpal.png", url: "/vrm/Cyberpal.vrm" },
  { id: "bao-samurai", name: "바오사무라이", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/bao-samurai.png", url: "/vrm/BaoSamurai.vrm" },
  {
    id: "kiba",
    name: "키바 (늑대)",
    thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/kiba.png",
    url: "/vrm/Kiba.vrm",
    limitations: ["limited-hand-rig"],
  },
  { id: "stitch-witch", name: "스티치위치 (마녀 인형)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/stitch-witch.png", url: "/vrm/StitchWitch.vrm" },
  { id: "mega-angel", name: "메가엔젤 (천사)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v1/mega-angel.png", url: "/vrm/MegaAngel.vrm" },
  { id: "mushroom-fairy", name: "머시룸페어리 (버섯 요정)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/mushroom-fairy.png", url: "/vrm/MushroomFairy.vrm" },
  { id: "weird-cat", name: "위어드캣 (고양이)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/weird-cat.png", url: "/vrm/WeirdCat.vrm" },
  { id: "cute-saurus", name: "큐트사우루스 (공룡)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cute-saurus.png", url: "/vrm/CuteSaurus.vrm" },
  { id: "crowley", name: "크롤리", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/crowley.png", url: "/vrm/Crowley.vrm" },
  { id: "lady-koi", name: "레이디코이 (비단잉어)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/lady-koi.png", url: "/vrm/LadyKoi.vrm" },
  { id: "yeti-dude", name: "예티듀드 (예티)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/yeti-dude.png", url: "/vrm/YetiDude.vrm" },
  { id: "anna", name: "안나", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/anna.png", url: "/vrm/Anna.vrm" },
  { id: "megan-the-fox", name: "메간 (여우)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/megan-the-fox.png", url: "/vrm/MeganTheFox.vrm" },
  { id: "cool-tiger", name: "쿨타이거 (호랑이)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cool-tiger.png", url: "/vrm/CoolTiger.vrm" },
  { id: "lil-ram", name: "릴램 (양)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/lil-ram.png", url: "/vrm/LilRam.vrm" },
  { id: "lady-fawn", name: "레이디폰 (아기사슴)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/lady-fawn.png", url: "/vrm/LadyFawn.vrm" },
  { id: "strawberry-princess", name: "스트로베리 프린세스 (공주)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/strawberry-princess.png", url: "/vrm/StrawberryPrincess.vrm" },
  { id: "blue-pixie", name: "블루픽시 (요정)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/blue-pixie.png", url: "/vrm/BluePixie.vrm" },
  { id: "bot-bunny", name: "봇버니 (토끼 로봇)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/bot-bunny.png", url: "/vrm/BotBunny.vrm" },
  { id: "sport-mecha", name: "스포츠메카 (메카)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/sport-mecha.png", url: "/vrm/SportMecha.vrm" },
  { id: "cosmic-bot", name: "코스믹봇 (로봇)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/cosmic-bot.png", url: "/vrm/CosmicBot.vrm" },
  { id: "old-moustache", name: "올드무스타치 (할아버지)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/old-moustache.png", url: "/vrm/OldMoustache.vrm" },
  { id: "eugenia", name: "유제니아 (할머니)", thumbnailUrl: "/assets/3d/characters/thumbnails/refined-v2/eugenia.png", url: "/vrm/Eugenia.vrm" },
];
