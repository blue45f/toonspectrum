  ...
  return (
    ...
    >
      ...
      {safe.hair.style !== "none" ? (
        <g data-hair-layer="back" fill={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.vrm.StudioVrmAvatarForgePreview", "en", "url(#{v0})"), { v0: String(hairGradientId) })} stroke={safe.hair.shadowColor ?? safe.hair.baseColor} strokeLinejoin="round" strokeWidth="2.4">
      ...
      {safe.hair.style !== "none" ? (
        <>
          <g data-hair-layer="bangs" fill={formatI18nTemplate(translateCurrentStaticSourceText("domains.creator.vrm.StudioVrmAvatarForgePreview", "en", "url(#{v0})"), { v0: String(hairGradientId) })} stroke={safe.hair.shadowColor ?? safe.hair.baseColor} strokeLinejoin="round" strokeWidth="2.2">
