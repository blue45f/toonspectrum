...
export const BRUSH_STUDIO_V7_MATERIAL_RECIPE_SEEDS: readonly BrushStudioV6RecipeSeed[] = Object.freeze([
  defineBrushStudioV6RecipeSeed("v7-hotpress-precision-graphite", "핫프레스 정밀 흑연", "V7 종이·건식", "매끈한 압착 수채지에서 미세 흑연 입자가 끊김 없이 이어지는 정밀 연필", {
  ...
  defineBrushStudioV6RecipeSeed("v7-hotpress-ink-glaze", "핫프레스 잉크 글레이즈", "V7 종이·잉크", "미세 압착 섬유를 드러내는 얇고 반투명한 일러스트 잉크", {
  ...
  defineBrushStudioV6RecipeSeed("v7-rough-mineral-watercolor", "러프 미네랄 플랫 수채", "V7 수채·과립", "넓은 평붓 가장자리와 큰 종이 골, 광물 입자가 동시에 드러나는 거친 과립 수채", {
  ...
  defineBrushStudioV6RecipeSeed("v7-rough-dry-gouache", "러프 드라이 과슈", "V7 종이·과슈", "거친 수채지의 산마루만 긁어 지나가는 불투명 드라이 과슈", {
  ...
  defineBrushStudioV6RecipeSeed("v7-laid-conte-hatch", "레이드 콩테 해치", "V7 판화·해칭", "제지망의 laid line을 타며 끊기고 다시 붙는 콩테 해칭", {
  ...
  defineBrushStudioV6RecipeSeed("v7-laid-letterpress-ink", "레이드 레터프레스 잉크", "V7 종이·잉크", "체인 라인과 제지망 결이 비치는 빈티지 인쇄 잉크", {
  ...
  defineBrushStudioV6RecipeSeed("v7-washi-sumi-fiber", "코조 화지 섬유 수묵", "V7 수묵·섬유", "닥 섬유를 따라 먹이 길게 번지고 가장자리에 농담이 남는 수묵", {
  ...
  defineBrushStudioV6RecipeSeed("v7-washi-dry-calligraphy", "코조 화지 갈필", "V7 서예·갈필", "긴 닥 섬유 때문에 먹선이 갈라지고 마르는 갈필 캘리그래피", {
  ...
  defineBrushStudioV6RecipeSeed("v7-sanded-charcoal-velour", "샌디드 벨루어 목탄", "V7 목탄·파스텔", "연마 그릿에 목탄 가루가 두껍게 걸리는 벨벳 질감", {
  ...
  defineBrushStudioV6RecipeSeed("v7-sanded-soft-pastel", "샌디드 소프트 파스텔", "V7 목탄·파스텔", "큰 그릿과 미세 사포 결 사이를 부드러운 파스텔이 불균일하게 메움", {
  ...
  defineBrushStudioV6RecipeSeed("v7-vellum-color-pencil", "벨럼 색연필", "V7 연필·세필", "벨럼의 막질 미세결을 따라 납 성분이 얇고 방향성 있게 쌓이는 색연필", {
  ...
  defineBrushStudioV6RecipeSeed("v7-vellum-fine-ink", "벨럼 파인 잉크", "V7 종이·잉크", "매끈하지만 완전히 균일하지 않은 벨럼용 세필 잉크", {
  ...
  defineBrushStudioV6RecipeSeed("v7-gesso-scrape-oil", "젯소 스크레이프 오일", "V7 유화·임파스토", "젯소 붓자국을 가로질러 물감이 산마루에 걸리고 골에서 긁히는 유화 스크레이프", {
  ...
  defineBrushStudioV6RecipeSeed("v7-gesso-dry-brush", "젯소 릿지 드라이브러시", "V7 유화·건식", "젯소의 긴 붓 릿지만 선택적으로 훑는 마른 페인트 브러시", {
  ...
  defineBrushStudioV6RecipeSeed("v7-heavy-canvas-impasto", "헤비 캔버스 임파스토", "V7 유화·임파스토", "굵은 날실·씨실 사이를 높은 물감 능선이 채우는 두꺼운 임파스토", {
  ...
  defineBrushStudioV6RecipeSeed("v7-heavy-canvas-scumble", "헤비 캔버스 스컴블", "V7 유화·건식", "캔버스 융기만 가볍게 건드리는 반투명 스컴블링", {
  ...
  defineBrushStudioV6RecipeSeed("v7-newsprint-bleed-marker", "뉴스프린트 블리드 마커", "V7 마커·흡수", "값싼 펄프지에서 잉크가 빠르게 먹고 외곽이 퍼지는 블리드 마커", {
  ...
  defineBrushStudioV6RecipeSeed("v7-newsprint-comic-ink", "뉴스프린트 코믹 잉크", "V7 만화·잉크", "펄프 섬유 때문에 가장자리가 미세하게 깨지는 빈티지 코믹 선화", {
  ...
  defineBrushStudioV6RecipeSeed("v7-kraft-graphite", "크라프트 섬유 흑연", "V7 연필·세필", "길게 눕는 크라프트 섬유에 흑연이 방향성 있게 걸리는 스케치 연필", {
  ...
  defineBrushStudioV6RecipeSeed("v7-kraft-brush-ink", "크라프트 브러시 잉크", "V7 종이·잉크", "크라프트의 긴 결을 따라 농도가 흔들리는 포스터용 브러시 잉크", {
  ...
  defineBrushStudioV6RecipeSeed("v7-woodgrain-drybrush", "우드그레인 드라이브러시", "V7 자연·텍스처", "목리를 따라 색이 길게 끊기며 실제 나뭇결처럼 흐르는 드라이브러시", {
  ...
  defineBrushStudioV6RecipeSeed("v7-woodgrain-stain", "우드그레인 스테인", "V7 자연·습식", "목리 골을 따라 반투명 안료가 번지는 스테인·워시", {
  ...
  defineBrushStudioV6RecipeSeed("v7-stone-grit-pastel", "스톤 그릿 파스텔", "V7 목탄·파스텔", "석분 결정의 높낮이에 따라 불규칙하게 걸리는 하드 파스텔", {
  ...
  defineBrushStudioV6RecipeSeed("v7-stone-grit-speckle", "스톤 그릿 스페클", "V7 FX·입자", "석분의 고주파 결정 위에 광물 안료 입자가 튀는 스페클 텍스처", {
