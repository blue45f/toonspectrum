...
import { studioEditorPersistenceWorkId } from "../../studio-editor-source-scope";
...
export function useStudioDocumentAccessRuntime({
  ...
  const persistenceWorkId = studioEditorPersistenceWorkId(documentLayout?.documentId ?? null, workId);
