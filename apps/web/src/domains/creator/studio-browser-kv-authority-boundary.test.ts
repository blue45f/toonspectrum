...
const ALLOWANCES: readonly BrowserKvAllowance[] = Object.freeze([
  ...
  allow("apps/web/src/domains/creator/virtual-space/studio-virtual-space-customization.ts", "local-storage-write", "\"toonspectrum:virtual-space-decoration:v1\"", 1, REVIEWED_LOCAL_WORKING_COPY, "studio-virtual-space-customization.test.ts bounds built-in decoration tokens, count, coordinates, scale, rotation, unique IDs, exact keys, invalid writes, and deterministic fallback without granting canonical world authority."),
