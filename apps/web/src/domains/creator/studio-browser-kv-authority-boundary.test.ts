...
const ALLOWANCES: readonly BrowserKvAllowance[] = Object.freeze([
  ...
  allow("apps/web/src/domains/creator/virtual-space/studio-virtual-space-entry-preference.ts", "local-storage-write", "\"toonspectrum:virtual-space-entry:v2\"", 1, UI_ONLY, "The entry gate stores only confirmed state plus the normalized built-in avatar index; it cannot carry authored images, world geometry, permissions, or collaboration consent."),
  ...
  allow("apps/web/src/domains/creator/virtual-space/studio-virtual-space-entry-preference.ts", "local-storage-cleanup", "\"toonspectrum:virtual-space-avatar:v1\"", 1, CLEANUP_ONLY, "Automatic avatar selection removes only the legacy cosmetic avatar index."),
  allow("apps/web/src/domains/creator/virtual-space/studio-virtual-space-art-style.ts", "local-storage-write", "\"toonspectrum:virtual-space-art-style:v1\"", 1, UI_ONLY, "studio-virtual-space-art-style.test.ts bounds the value to five presentation-only art-direction keys; no world geometry, document state, media consent, or remote authority is stored."),
