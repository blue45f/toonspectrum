...
const ALLOWANCES: readonly BrowserKvAllowance[] = Object.freeze([
  ...
  allow("apps/web/src/domains/creator/virtual-space/StudioVirtualSpacePage.tsx", "local-storage-write", "\"toonspectrum:virtual-atmosphere:v1\"", 1, UI_ONLY, "Only focus, balanced or lively local presentation preference is stored. StudioVirtualSpacePage.social.test.tsx verifies focus cancels shared actions through the existing controller, not persisted room authority."),
