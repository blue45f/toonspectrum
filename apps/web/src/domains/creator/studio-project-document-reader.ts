/** Read-only document metadata; opening a manuscript must not load library mutation commands. */
...
export const DOCUMENT_KIND_SET = new Set<string>(STUDIO_DOCUMENT_KINDS);
...
export const MAX_DOCUMENTS_PER_PROJECT = 10_000;
