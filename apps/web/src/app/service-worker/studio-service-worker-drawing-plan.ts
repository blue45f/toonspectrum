...
export const DRAWING_ROOTS = ["StudioRouter", "StudioInspectorAside", "StudioToolHintBubble", "StudioColorVisionHintPreview", "studio-legacy-editor-adapter", "studio-pages-history-durable-runtime",
  "studio-durable-save-intent-sqlite", "studio-watermark-preferences-sqlite", "StudioEnhancedExportMenuPanel", "studio-export", "studio-capture-readiness", "studio-project-file", "studio-release-schedule", "studio-publication-analytics", "studio-autosave-sqlite-store", "studio-local-database-worker-client"];
