...
export const DRAWING_ROOTS = ["studio-live-collaboration-room", "studio-live-adaptive-cursor-transport", "studio-crdt-document", "studio-crdt-room-binding", "studio-crdt-scene-publisher", "studio-crdt-history", "studio-crdt-page-bridge", "studio-crdt-raster-ui-bridge", "studio-autosave-opfs-session", "studio-checkpoints", "StudioRouter", "StudioInspectorAside", "StudioToolHintBubble", "StudioColorVisionHintPreview", "studio-legacy-editor-adapter", "studio-pages-history-durable-runtime",
