...
(() => {
  ...
  function offer() {
    ...
    const message = document.createElement('span'); message.textContent = '스튜디오 화면을 복구하지 못했습니다. 긴급 드로잉은 기존 프로젝트와 분리된 임시 원고입니다.';
    const link = document.createElement('a'); link.href = '/offline-draw/'; link.target = '_blank'; link.rel = 'noopener'; link.textContent = '긴급 복구 드로잉 열기';
