...
const room={workId:"private-qa",participant:self,get ready(){return channel?.readyState==="open";},get direct(){return this.ready?direct:null;},
  get acousticCoreBinding(){return this.ready?{connectionId:`socket-${index}`,clientInstanceId:self.sessionId}:null;},
