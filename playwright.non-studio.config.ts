...
export default defineConfig({
  testDir: "./e2e",
  testMatch: ["beta-open-event-gate.spec.ts", "atelier-public-polish.spec.ts", "non-studio-experience.spec.ts", "non-studio-controls.spec.ts", "non-studio-search-layout.spec.ts", "creator-flagship.spec.ts", "open-creation.spec.ts", "engineering-story.spec.ts", "production-risk-intelligence.spec.ts", "studio-exact-resume.spec.ts", "learn.spec.ts", "learn-resilience.spec.ts", "learn-guided-lessons.spec.ts"],
  fullyParallel: false,
