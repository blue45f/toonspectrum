...
| final bundle budget | route raw/gzip **4,640.1/1,487.4KiB**, StudioPage **1,953.2/575.8KiB**, app shell 이후 **4,057.5/1,304.0KiB**, request **190**, route chunk **199**; baseline regression **0**, 개선 2건. 최종 병합 `main`에서는 동일 bundle gate를 재실행해야 한다 |
