...
These are the original branch records, not fresh evidence for the later five-branch integration. Current integration decisions are recorded in `docs/operations/five-branch-reconciliation-20260921.md`; exact-head results belong to its PR.
