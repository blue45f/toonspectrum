...
음성 통화 후속 항목은 2026-07-18에 별도 동의·권한·수명주기를 가진 최대 6인 WebRTC P2P
작업실로 구현했다. 채팅/댓글과 달리 음성·SDP·ICE는 어떤 작품 기록에도 남기지 않으며 상세
계약은 `docs/studio-voice-workroom-2026-07-18.md`에 정리한다.
