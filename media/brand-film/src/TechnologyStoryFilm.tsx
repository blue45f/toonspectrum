...
const OVERVIEW_SCENES: readonly TechnologyScene[] = [
  ...
  {
    kicker: "03 · WORKER · PWA · LOCAL-FIRST",
    title: "무거운 계산은 격리하고\n작업 연속성은 지킵니다.",
    body: "typed Worker, Transferable, OPFS·SQLite WASM과 사용자 승인형 Service Worker 업데이트로 UI, 원본과 앱 셸의 책임을 분리합니다.",
    label: "CONTINUITY",
    points: ["Worker", "PWA", "OPFS", "Recovery"],
  },
  {
    kicker: "04 · WEB 3D · BLENDER · MCP",
    title: "거대한 한 엔진보다\n전문 도구를 연결합니다.",
  ...
  {
    kicker: "07 · TROUBLESHOOTING · EVIDENCE",
    title: "실패를 숨기지 않고\n회귀 검사로 남깁니다.",
  ...
  {
    kicker: "08 · REUSABLE ENGINEERING",
