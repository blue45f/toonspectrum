...
const OVERVIEW_SCENES: readonly TechnologyScene[] = [
  ...
  {
    kicker: "04 · WORKER · PWA · LOCAL-FIRST · BROWSER EXECUTION",
  ...
  {
    kicker: "09 · TROUBLESHOOTING · EVIDENCE",
    title: "실패를 숨기지 않고\n회귀 검사로 남깁니다.",
  ...
  {
    kicker: "11 · REUSABLE ENGINEERING",
