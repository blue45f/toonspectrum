import { UnsupportedSceneFeatureError } from "@toonspectrum/project-model-v11";
...
import type { ColorIR, PathIR, SceneIR, SceneNodeIR } from "@toonspectrum/project-model-v11";
