...
CREATE INDEX IF NOT EXISTS traffic_page_view_session_occurred_idx
  ON traffic_page_view (session_hash, occurred_at DESC);
CREATE INDEX IF NOT EXISTS traffic_page_view_visitor_occurred_idx
  ON traffic_page_view (visitor_hash, occurred_at DESC);
CREATE INDEX IF NOT EXISTS traffic_page_view_path_occurred_idx
  ON traffic_page_view (path, occurred_at DESC);
...
CREATE INDEX IF NOT EXISTS traffic_share_event_session_occurred_idx
  ON traffic_share_event (session_hash, occurred_at DESC);
CREATE INDEX IF NOT EXISTS traffic_share_event_path_occurred_idx
  ON traffic_share_event (path, occurred_at DESC);
CREATE INDEX IF NOT EXISTS traffic_share_event_channel_occurred_idx
  ON traffic_share_event (channel, occurred_at DESC);
