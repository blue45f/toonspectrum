...
export const STUDIO_BRUSH_RUNTIME_CONTRACT = [
  ...
  { id: "chisel-highlighter", family: "highlighter", engine: "highlighter-path", engineVariant: "multiply-square", canonicalId: "highlighter", preview: "solid", tip: "square", texture: "none", dynamics: "fixed-path", distinctness: "profile-variant" },
  { id: "pastel-highlighter", family: "highlighter", engine: "highlighter-path", engineVariant: "multiply-square", canonicalId: "highlighter", preview: "solid", tip: "square", texture: "none", dynamics: "fixed-path", distinctness: "profile-variant" },
  ...
  { id: "splatter", family: "airbrush", engine: "dynamic-dabs", engineVariant: "splatter", canonicalId: "airbrush", preview: "soft", tip: "flake", texture: "custom-alpha-capable", dynamics: "mapped-dabs", distinctness: "engine-variant" },
  ...
  { id: "oil-pastel", family: "pastel", engine: "pastel-dabs", engineVariant: "soft-grain", canonicalId: "pastel", preview: "soft", tip: "grain", texture: "procedural-grain", dynamics: "pastel-pressure", distinctness: "profile-variant" },
...
> = {
  ...
  "dynamic-dabs": {
    ...
    splatter: { families: ["airbrush"], previews: ["soft"], tip: "flake", texture: "custom-alpha-capable", dynamics: "mapped-dabs" },
