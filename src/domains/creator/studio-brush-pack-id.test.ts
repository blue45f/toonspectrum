...
describe("procedural brush pack ids", () => {
  it("publishes exactly 67 stable, unique catalogue ids", () => {
    expect(STUDIO_BRUSH_PACK_CATALOG_IDS).toHaveLength(67);
    expect(new Set(STUDIO_BRUSH_PACK_CATALOG_IDS).size).toBe(67);
