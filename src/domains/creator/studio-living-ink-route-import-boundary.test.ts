...
const WGSL_LIBRARY = "src/domains/creator/studio-living-ink-wgsl-shaders.ts";
const FLUID_REFERENCE_LEAF = "src/domains/creator/studio-living-ink-fluid-reference.ts";
const SETTLED_BAKE = "src/domains/creator/studio-living-ink-settled-bake-v1.ts";
