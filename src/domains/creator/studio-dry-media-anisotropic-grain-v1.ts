...
export const STUDIO_DRY_MEDIA_ANISOTROPIC_PRESETS_V1 = Object.freeze({
  crayon: freezePreset({
    ...
    spacingRatio: 0.3,
    minimumSpacing: 0.45,
    widthScale: { minimum: 0.42, maximum: 1.08, pressureCurve: 0.78 },
    opacityScale: { minimum: 0.38, maximum: 0.92, pressureCurve: 0.72 },
    flowScale: { minimum: 0.48, maximum: 0.94, pressureCurve: 0.82 },
    halfLengthRatio: { minimum: 0.42, maximum: 0.68 },
    halfThicknessRatio: { minimum: 0.065, maximum: 0.13 },
    minimumAspectRatio: 3.1,
    lateralSpread: 0.42,
    longitudinalJitter: 0.22,
    orientationJitterRadians: 0.14,
    tangentResponse: 0.82,
    tiltOrientationInfluence: 0.3,
    twistInfluence: 0.08,
    hardness: { minimum: 0.58, maximum: 0.9 },
    edgeRoughness: { minimum: 0.18, maximum: 0.46 },
    grainFrequency: { minimum: 0.8, maximum: 1.9 },
    superellipseExponent: { minimum: 2.6, maximum: 4.5 },
  }),
  charcoal: freezePreset({
    ...
    halfLengthRatio: { minimum: 0.55, maximum: 0.92 },
    halfThicknessRatio: { minimum: 0.045, maximum: 0.095 },
    minimumAspectRatio: 5,
    lateralSpread: 0.56,
    longitudinalJitter: 0.34,
    orientationJitterRadians: 0.2,
    tangentResponse: 0.7,
  ...
  chalk: freezePreset({
    ...
    halfLengthRatio: { minimum: 0.32, maximum: 0.58 },
    halfThicknessRatio: { minimum: 0.09, maximum: 0.17 },
    minimumAspectRatio: 2.35,
    lateralSpread: 0.5,
    longitudinalJitter: 0.4,
    orientationJitterRadians: 0.32,
  ...
  pastel: freezePreset({
    ...
    halfLengthRatio: { minimum: 0.38, maximum: 0.7 },
    halfThicknessRatio: { minimum: 0.065, maximum: 0.13 },
    minimumAspectRatio: 3,
    lateralSpread: 0.6,
    longitudinalJitter: 0.26,
    orientationJitterRadians: 0.24,
