...
const brushMenu = readFileSync(
  resolve(process.cwd(), "src/domains/creator/studio-main-menu-items-brush.ts"),
  "utf8",
);
const canvasMenu = readFileSync(
  resolve(process.cwd(), "src/domains/creator/studio-main-menu-items-authoring.ts"),
  "utf8",
);
const storyMenu = readFileSync(
  resolve(process.cwd(), "src/domains/creator/studio-main-menu-items-story.ts"),
  "utf8",
);
const collabMenu = readFileSync(
  resolve(process.cwd(), "src/domains/creator/studio-main-menu-items-collaboration.ts"),
  "utf8",
);
