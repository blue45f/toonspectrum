...
describe("Studio route manifest", () => {
  ...
  it.each([
    ...
    [
      ...
      "?room=team-a",
      "brush-lab",
      "/studio/work/work-1/brush-lab?room=team-a",
      "/studio/work:work-1/brush-lab",
    ],
    [
      "/studio/remix/source-1/brush-lab",
      "",
      "brush-lab",
      "/studio/remix/source-1/brush-lab",
      "/studio/remix:source-1/brush-lab",
  ...
  it("derives the editor return from validated identity, never returnTo", () => {
    expect(resolveStudioRoute({
      pathname: "/studio/work/work-1/brush-lab",
      search: "?returnTo=https%3A%2F%2Fevil.example",
    })).toMatchObject({
      canonicalHref: "/studio/work/work-1/brush-lab",
