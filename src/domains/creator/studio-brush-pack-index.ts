...
const DESCRIPTOR_ROWS: readonly DescriptorRow[] = [
  ...
  ["젖은 수채 번짐", "수채 번짐", "물을 많이 머금은 붓이 종이 위에서 몽글하게 퍼지는 습식 수채 획", "paint", 30, 0.5, "airbrush", "paint", "soft", 0.8],
  ...
  ["대구경 에어브러시", "대구경 에어", "그라데이션과 피부 명암을 한 번에 덮는 초대형 연질 분사 노즐", "paint", 64, 0.4, "airbrush", "paint", "soft", 1],
  ["스펀지 스티플", "스티플", "간격을 두고 도장처럼 찍히는 스펀지 두들김으로 질감을 쌓는 촉", "texture", 24, 0.8, "dry-media", "texture", "dots", 0.7],
  ["무색 블렌더 마커", "블렌더", "색을 얹지 않고 경계만 옅게 풀어 문지르는 무색 혼합 마커", "marker", 30, 0.2, "airbrush", "marker", "soft", 0.8],
  ...
  ["뭉게구름 스모크", "뭉게구름", "큰 노이즈 덩어리로 구름과 연기 볼륨을 뭉게뭉게 쌓는 초연질 촉", "effect", 56, 0.32, "airbrush", "fx", "soft", 0.95],
  ...
  ["습식 넓은 워시", "습식 워시", "넓은 물층이 겹치며 가장자리 농도와 속도별 물감량이 달라지는 워시 붓", "paint", 58, 0.34, "airbrush", "paint", "soft", 0.96],
  ...
  ["겹연기 실루엣", "겹연기", "휘어지는 연기 가닥과 부드러운 입자층을 겹쳐 깊이 있는 연무를 만드는 붓", "effect", 52, 0.28, "airbrush", "fx", "soft", 0.96],
  ...
  ["권운 흐름", "권운", "길고 가는 구름 가닥이 획의 흐름을 따라 휘어져 하늘의 방향감을 만드는 붓", "effect", 58, 0.3, "airbrush", "fx", "wavy", 0.96],
