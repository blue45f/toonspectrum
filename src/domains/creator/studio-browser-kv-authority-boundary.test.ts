...
const ALLOWANCES: readonly BrowserKvAllowance[] = Object.freeze([
  ...
  allow("src/domains/creator/bg3d/studio-bg3d-lt-preset-storage.ts", "durable-storage-write", '"toonspectrum.studio.bg3d.lt-presets.v1"', 2, INJECTED_COMPATIBILITY, INJECTED_PROOF),
  allow("src/domains/creator/bg3d/studio-bg3d-lt-preset-storage.ts", "durable-storage-write", '"toonspectrum.studio.bg3d.lt-presets.corrupt.v1"', 1, INJECTED_COMPATIBILITY, INJECTED_PROOF),
  ...
  allow("src/domains/creator/brush/studio-brush-library-repository.ts", "durable-storage-write", "key", 1, INJECTED_COMPATIBILITY, INJECTED_PROOF),
  allow("src/domains/creator/brush/studio-brush-library-sqlite-repository.ts", "durable-storage-write", '"toonspectrum-studio-v12-brush-library-fallback"', 1, INJECTED_COMPATIBILITY, INJECTED_PROOF),
  allow("src/domains/creator/brush/studio-brush-library.ts", "durable-storage-write", '"toonspectrum-studio-brush-library"', 1, INJECTED_COMPATIBILITY, INJECTED_PROOF),
  ...
  allow("src/domains/creator/filter/studio-filter-library-sqlite-repository.ts", "durable-storage-write", "storageKey", 1, INJECTED_COMPATIBILITY, INJECTED_PROOF),
  ...
  allow("src/domains/creator/bg3d/bg3d-model-library.ts", "indexeddb-open", '"toonspectrum-studio-bg3d-model-library"', 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/bg3d-model-library.ts", "indexeddb-write", "add", 2, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/bg3d-model-library.ts", "indexeddb-write", "put", 3, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/bg3d-model-library.ts", "indexeddb-cleanup", "delete", 2, CLEANUP_ONLY, CLEANUP_PROOF),
  allow("src/domains/creator/bg3d/bg3d-template-library.ts", "indexeddb-open", '"toonspectrum-studio-bg3d-template-library"', 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/bg3d-template-library.ts", "indexeddb-write", "put", 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/bg3d-template-library.ts", "indexeddb-cleanup", "delete", 1, CLEANUP_ONLY, CLEANUP_PROOF),
  ...
  allow("src/domains/creator/studio-asset-library.ts", "indexeddb-cleanup", "delete", 2, CLEANUP_ONLY, CLEANUP_PROOF),
  allow("src/domains/creator/bg3d/studio-bg3d-asset-metadata-store.ts", "indexeddb-open", '"toonspectrum-studio-bg3d-asset-metadata"', 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/studio-bg3d-asset-metadata-store.ts", "indexeddb-write", "put", 2, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/studio-bg3d-asset-metadata-store.ts", "indexeddb-cleanup", "delete", 1, CLEANUP_ONLY, CLEANUP_PROOF),
  allow("src/domains/creator/bg3d/studio-bg3d-shot-batch-recovery-store.ts", "indexeddb-open", '"toonspectrum-studio-bg3d-shot-batch-recovery"', 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/studio-bg3d-shot-batch-recovery-store.ts", "indexeddb-write", "put", 2, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/bg3d/studio-bg3d-shot-batch-recovery-store.ts", "indexeddb-cleanup", "delete", 1, CLEANUP_ONLY, CLEANUP_PROOF),
  ...
  allow("src/domains/creator/live/studio-crdt-outbox.ts", "indexeddb-open", '"toonspectrum-studio-crdt-outbox"', 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/live/studio-crdt-outbox.ts", "indexeddb-write", "put", 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/live/studio-crdt-outbox.ts", "indexeddb-cleanup", "delete", 1, CLEANUP_ONLY, CLEANUP_PROOF),
  ...
  allow("src/domains/creator/vrm/studio-vrm-texture-paint-library.ts", "indexeddb-open", '"toonspectrum-studio-vrm-texture-paint-library"', 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/vrm/studio-vrm-texture-paint-library.ts", "indexeddb-write", "put", 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/vrm/studio-vrm-texture-paint-library.ts", "indexeddb-cleanup", "delete", 2, CLEANUP_ONLY, CLEANUP_PROOF),
  allow("src/domains/creator/vrm/vrm-library.ts", "indexeddb-open", '"toonspectrum-studio-vrm-library"', 1, LEGACY_IDB, LEGACY_IDB_PROOF),
  allow("src/domains/creator/vrm/vrm-library.ts", "indexeddb-write", "put", 6, VRM_LIBRARY_MIXED_PERSISTENCE, VRM_LIBRARY_MIXED_PERSISTENCE_PROOF),
  allow("src/domains/creator/vrm/vrm-library.ts", "indexeddb-cleanup", "delete", 2, CLEANUP_ONLY, CLEANUP_PROOF),
]);
