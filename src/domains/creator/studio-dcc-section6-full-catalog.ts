...
export const STUDIO_DCC_SECTION6_CATALOG: readonly StudioSection6CatalogEntry[] = [
  ...
  { id: "DOC-013", name: "self-host/export CLI contract", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["parseStudioSelfHostExportCliContract"] },
  { id: "DOC-014", name: "offline queue\u00b7reconnect", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["flushStudioOfflineQueue"] },
  ...
  { id: "MOD-023", name: "vertex group/selection set", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["createStudioVertexGroupSelectionSet"] },
  ...
  { id: "BLD-008", name: "section plane\u00b7cutaway", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["sectionPlaneCutawayStudioMeshVerts"] },
  ...
  { id: "BLD-013", name: "road/sidewalk/lane generator", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["generateStudioRoadSidewalkLane"] },
  ...
  { id: "BLD-017", name: "component metadata", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["buildStudioComponentMetadata"] },
  ...
  { id: "CAD-007", name: "fillet/chamfer", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["chamferStudioCadCorner2d"] },
  ...
  { id: "CAD-009", name: "pattern/mirror", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["patternMirrorStudioCadPoints"] },
  { id: "CAD-010", name: "datum plane/axis/coordinate system", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["createStudioCadDatumPlaneAxisCsys"] },
  ...
  { id: "CAD-013", name: "configuration/variant", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["configureStudioCadVariant"] },
  ...
  { id: "CAD-020", name: "drawing sheet/BOM lite", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["buildStudioDrawingSheetBomLite"] },
  ...
  { id: "SCP-003", name: "symmetry/radial symmetry", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["applyStudioSculptSymmetryRadial"] },
  { id: "SCP-004", name: "face set/polygroup", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["assignStudioSculptFaceSetPolygroup"] },
  ...
  { id: "CHR-005", name: "ground/seat/wall contact", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["resolveStudioGroundSeatWallContact"] },
  { id: "CHR-006", name: "two-character interaction", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["planStudioTwoCharacterInteraction"] },
  ...
  { id: "CHR-014", name: "animation curve editor", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["sampleStudioAnimationCurveLite"] },
  { id: "CHR-015", name: "onion/ghost pose", priority: "P2", status: "shipped", module: "studio-character-animation-p2.ts", apis: ["diffStudioPoses"] },
  { id: "CHR-016", name: "body proportion control", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["scaleStudioBodyProportion"] },
  { id: "CHR-017", name: "character variant", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["createStudioCharacterVariant"] },
  ...
  { id: "CHR-019", name: "MToon/PBR material bridge", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["bridgeStudioMtoonPbr"] },
  { id: "CHR-020", name: "VRM export", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["exportStudioVrmLite"] },
  ...
  { id: "GAR-003", name: "arrangement on avatar", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["arrangeStudioGarmentOnAvatar"] },
  { id: "GAR-004", name: "fabric presets", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["listStudioFabricPresets"] },
  ...
  { id: "GAR-006", name: "avatar collision proxy", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["buildStudioAvatarCollisionProxy"] },
  ...
  { id: "GAR-009", name: "garment skinning bake", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["bakeStudioGarmentSkinning"] },
  { id: "GAR-010", name: "animation cloth cache", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["cacheStudioAnimationCloth"] },
  { id: "GAR-011", name: "garment layer/order", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["orderStudioGarmentLayers"] },
  { id: "GAR-012", name: "retopo/UV transfer", priority: "P4", status: "shipped", module: "studio-uv-unwrap-lite.ts", apis: ["unwrapStudioMeshBox"] },
  { id: "GAR-013", name: "DXF/AAMA pattern bridge", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["bridgeStudioDxfAamaPattern"] },
  { id: "GAR-014", name: "CLO/Marvelous bridge", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["bridgeStudioCloMarvelous"] },
  { id: "GAR-015", name: "comic wrinkle exaggeration", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["exaggerateStudioComicWrinkle"] },
  ...
  { id: "MAT-007", name: "procedural noise/pattern", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["generateStudioProceduralNoisePattern"] },
  { id: "MAT-008", name: "MaterialX import", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["importStudioMaterialXLite"] },
  ...
  { id: "MAT-011", name: "atlas/texture set", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["packStudioAtlasTextureSet"] },
  ...
  { id: "PRC-001", name: "typed node graph", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["evaluateStudioTypedNodeGraph"] },
  ...
  { id: "PRC-006", name: "cache/bake/freeze", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["freezeStudioProceduralCacheBake"] },
  { id: "PRC-007", name: "custom script sandbox", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["runStudioCustomScriptSandbox"] },
  { id: "PRC-008", name: "reusable generator asset", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["registerStudioReusableGeneratorAsset"] },
  ...
  { id: "NPR-002", name: "silhouette/crease/boundary", priority: "P1", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["extractStudioSilhouetteCreaseBoundary"] },
  { id: "NPR-003", name: "intersection/contact line", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["detectStudioIntersectionContactLine"] },
  ...
  { id: "NPR-007", name: "line cleanup", priority: "P2", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["cleanupStudioNprLine"] },
