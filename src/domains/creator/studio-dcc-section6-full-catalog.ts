...
export const STUDIO_DCC_SECTION6_CATALOG: readonly StudioSection6CatalogEntry[] = [
  ...
  { id: "CAD-006", name: "sweep/loft", priority: "P3", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["extrudeStudioCadProfile"] },
  ...
  { id: "CAD-008", name: "shell/draft", priority: "P3", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["measureStudioCadExtrusion"] },
  ...
  { id: "CAD-012", name: "assembly mate lite", priority: "P4", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["assembleStudioCadMateLite"] },
  ...
  { id: "CAD-016", name: "Rhino 3DM", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["bridgeStudioRhino3dmLite"] },
  ...
  { id: "CAD-019", name: "BIM\u2192Room Builder mapping", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["mapStudioBimToRoomBuilder"] },
  ...
  { id: "SCP-006", name: "dynamic topology", priority: "P4", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["subdivideStudioMeshCatmullLite"] },
  ...
  { id: "SCP-011", name: "automatic retopo basic", priority: "P4", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["decimateStudioMesh"] },
  ...
  { id: "SCP-014", name: "normal/AO/curvature/ID bake", priority: "P3", status: "shipped", module: "studio-dcc-section6-lite-ops.ts", apis: ["bakeStudioSculptPasses"] },
