...
export const STUDIO_DCC_SECTION6_CATALOG: readonly StudioSection6CatalogEntry[] = [
  ...
  { id: "CAD-016", name: "Rhino 3DM", priority: "P3", status: "shipped", module: "studio-rhino3dm-lite.ts", apis: ["parseStudioRhino3dmLite"] },
  ...
  { id: "CAD-018", name: "IFC property/space/wall/opening", priority: "P3", status: "shipped", module: "studio-mesh-format-adapters.ts", apis: ["importStudioIfcShell"] },
