...
export const STUDIO_DCC_SECTION6_CATALOG: readonly StudioSection6CatalogEntry[] = [
  ...
  { id: "DOC-009", name: "large binary lock/branch/merge", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["mergeStudioBinaryLockBranch"] },
  { id: "DOC-010", name: "review pin\u00b7status\u00b7approval", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["resolveStudioReviewPinApproval"] },
  { id: "DOC-011", name: "audit log\u00b7role permission", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["buildStudioAuditLogRolePermission"] },
  { id: "DOC-012", name: "Rights BOM", priority: "P1", status: "shipped", module: "studio-hybrid-dcc-document.ts", apis: ["hybridDccRegisterAsset"] },
  { id: "DOC-013", name: "self-host/export CLI contract", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["parseStudioSelfHostExportCliContract"] },
  { id: "DOC-014", name: "offline queue\u00b7reconnect", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["flushStudioOfflineQueue"] },
  ...
  { id: "MOD-018", name: "Decimate", priority: "P2", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["decimateStudioMesh"] },
  { id: "MOD-019", name: "Weighted Normal/Weld", priority: "P2", status: "shipped", module: "studio-editable-half-edge-mesh.ts", apis: ["weldStudioEditableMesh"] },
  { id: "MOD-020", name: "Curve/Lattice/Simple Deform", priority: "P2", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["deformStudioMeshBend"] },
  { id: "MOD-021", name: "Shrinkwrap", priority: "P2", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["shrinkwrapStudioMesh"] },
  { id: "MOD-022", name: "Retopology snap", priority: "P3", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["retopoSnapStudioMeshToPlane"] },
  { id: "MOD-023", name: "vertex group/selection set", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["createStudioVertexGroupSelectionSet"] },
  ...
  { id: "MOD-025", name: "mesh repair", priority: "P2", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["repairStudioMesh"] },
  ...
  { id: "BLD-005", name: "Follow Me/Sweep", priority: "P2", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["extrudeStudioCadProfile"] },
  ...
  { id: "BLD-008", name: "section plane\u00b7cutaway", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["sectionPlaneCutawayStudioMeshVerts"] },
  ...
  { id: "BLD-013", name: "road/sidewalk/lane generator", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["generateStudioRoadSidewalkLane"] },
  { id: "BLD-014", name: "fence/pole/tree scatter", priority: "P2", status: "shipped", module: "studio-procedural-scatter.ts", apis: ["scatterStudioInstances"] },
  ...
  { id: "BLD-017", name: "component metadata", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["buildStudioComponentMetadata"] },
  ...
  { id: "BLD-019", name: "style presets", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["listStudioStylePresets"] },
  { id: "BLD-020", name: "plan/elevation/section view", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["listStudioPlanElevationSectionViews"] },
  ...
  { id: "CAD-005", name: "extrude/revolve", priority: "P2", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["extrudeStudioCadProfile", "revolveStudioCadProfile"] },
  { id: "CAD-006", name: "sweep/loft", priority: "P3", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["sweepStudioCadProfile", "loftStudioCadProfiles"] },
  { id: "CAD-007", name: "fillet/chamfer", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["chamferStudioCadCorner2d"] },
  { id: "CAD-008", name: "shell/draft", priority: "P3", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["shellDraftStudioCadExtrusion"] },
  { id: "CAD-009", name: "pattern/mirror", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["patternMirrorStudioCadPoints"] },
  { id: "CAD-010", name: "datum plane/axis/coordinate system", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["createStudioCadDatumPlaneAxisCsys"] },
  { id: "CAD-011", name: "feature history tree", priority: "P3", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["orderStudioCadFeatureTree"] },
  { id: "CAD-012", name: "assembly mate lite", priority: "P4", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["solveStudioCadAssemblyMates"] },
  { id: "CAD-013", name: "configuration/variant", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["configureStudioCadVariant"] },
  { id: "CAD-014", name: "exact measure/mass property", priority: "P3", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["measureStudioCadExtrusion"] },
  { id: "CAD-015", name: "STEP/IGES/BREP import/export", priority: "P3", status: "shipped", module: "studio-cad-kernel-lite.ts", apis: ["exportStudioCadStepAscii", "importStudioStepShell"] },
  { id: "CAD-016", name: "Rhino 3DM openNURBS full NURBS eval", priority: "P2", status: "shipped", module: "studio-rhino3dm-nurbs.ts", apis: ["evaluateStudioNurbsCurve", "evaluateStudioNurbsSurfaceSuite", "parseStudioRhino3dmOpenNurbs"] },
  { id: "CAD-017", name: "DXF plan import/export", priority: "P2", status: "shipped", module: "studio-mesh-format-adapters.ts", apis: ["importStudioDxfPlan"] },
  { id: "CAD-018", name: "IFC city/building body (web-ifc)", priority: "P2", status: "shipped", module: "studio-web-ifc-city.ts", apis: ["importStudioIfcCity", "createStudioIfcCityFixture"] },
  { id: "CAD-019", name: "BIM→Room Builder mapping", priority: "P3", status: "shipped", module: "studio-bim-room-builder-map.ts", apis: ["mapStudioBimIfcToRoomBuilder"] },
  { id: "CAD-020", name: "drawing sheet/BOM lite", priority: "P4", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["buildStudioDrawingSheetBomLite"] },
  ...
  { id: "SCP-002", name: "mask/invert/blur/grow/shrink", priority: "P3", status: "shipped", module: "studio-hybrid-sculpt-kernel.ts", apis: ["createStudioSculptMask"] },
  { id: "SCP-003", name: "symmetry/radial symmetry", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["applyStudioSculptSymmetryRadial"] },
  { id: "SCP-004", name: "face set/polygroup", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["assignStudioSculptFaceSetPolygroup"] },
  { id: "SCP-005", name: "voxel remesh", priority: "P3", status: "shipped", module: "studio-hybrid-sculpt-kernel.ts", apis: ["voxelRemeshStudioMesh"] },
  { id: "SCP-006", name: "dynamic topology", priority: "P4", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["dynatopoStudioMeshBrushLocal"] },
  { id: "SCP-007", name: "multires subdivision levels", priority: "P4", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["subdivideStudioMeshCatmullLite"] },
  { id: "SCP-008", name: "polypaint/material paint", priority: "P3", status: "shipped", module: "studio-hybrid-sculpt-kernel.ts", apis: ["polypaintStudioMesh"] },
  { id: "SCP-009", name: "alpha/stamp/texture brush", priority: "P3", status: "shipped", module: "studio-hybrid-sculpt-kernel.ts", apis: ["applyStudioSculptStroke"] },
  { id: "SCP-010", name: "project detail", priority: "P4", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["subdivideStudioMeshCatmullLite", "shrinkwrapStudioMesh"] },
  { id: "SCP-011", name: "automatic retopo basic", priority: "P4", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["autoRetopoStudioMeshBasic"] },
  { id: "SCP-012", name: "manual quad retopo", priority: "P3", status: "shipped", module: "studio-editable-half-edge-mesh.ts", apis: ["createStudioEditableMeshFromPolygons"] },
  { id: "SCP-013", name: "UV unwrap/pack", priority: "P2", status: "shipped", module: "studio-uv-unwrap-lite.ts", apis: ["unwrapStudioMeshBox", "packStudioUvIslands"] },
  { id: "SCP-014", name: "normal/AO/curvature/ID bake", priority: "P3", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["bakeStudioMeshMaps"] },
  { id: "SCP-015", name: "proxy/high-res link", priority: "P3", status: "shipped", module: "studio-mesh-ops-advanced.ts", apis: ["subdivideStudioMeshCatmullLite"] },
  ...
  { id: "CHR-004", name: "joint limit\u00b7preferred pose", priority: "P2", status: "shipped", module: "studio-character-animation-p2.ts", apis: ["clampStudioJointRotation"] },
  { id: "CHR-005", name: "ground/seat/wall contact", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["resolveStudioGroundSeatWallContact"] },
  { id: "CHR-006", name: "two-character interaction", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["planStudioTwoCharacterInteraction"] },
  { id: "CHR-007", name: "hand pose library", priority: "P1", status: "shipped", module: "studio-character-pose-p1.ts", apis: ["mirrorStudioHandPose"] },
  ...
  { id: "CHR-010", name: "spring bone preview", priority: "P2", status: "shipped", module: "studio-character-animation-p2.ts", apis: ["stepStudioSpringBone"] },
  { id: "CHR-011", name: "animation clip library", priority: "P2", status: "shipped", module: "studio-character-animation-p2.ts", apis: ["createStudioIdleClip", "sampleStudioAnimationClip"] },
  { id: "CHR-012", name: "retarget FBX/BVH/VRMA", priority: "P2", status: "shipped", module: "studio-character-animation-p2.ts", apis: ["retargetStudioMotionReport"] },
  { id: "CHR-013", name: "pose capture", priority: "P2", status: "shipped", module: "studio-character-ik-fk.ts", apis: ["createStudioDefaultBodyPose"] },
  { id: "CHR-014", name: "animation curve editor", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["sampleStudioAnimationCurveLite"] },
  { id: "CHR-015", name: "onion/ghost pose", priority: "P2", status: "shipped", module: "studio-character-animation-p2.ts", apis: ["diffStudioPoses"] },
  { id: "CHR-016", name: "body proportion control", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["scaleStudioBodyProportion"] },
  { id: "CHR-017", name: "character variant", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["createStudioCharacterVariant"] },
  ...
  { id: "CHR-019", name: "MToon/PBR material bridge", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["bridgeStudioMtoonPbr"] },
  { id: "CHR-020", name: "VRM export", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["exportStudioVrmLite"] },
  { id: "GAR-001", name: "2D pattern editor", priority: "P3", status: "shipped", module: "studio-cloth-pattern-kernel.ts", apis: ["createStudioClothPatternPanel"] },
  { id: "GAR-002", name: "seam pairing/direction", priority: "P3", status: "shipped", module: "studio-cloth-pattern-kernel.ts", apis: ["validateStudioClothSeam", "createStudioClothPatternPanel"] },
  { id: "GAR-003", name: "arrangement on avatar", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["arrangeStudioGarmentOnAvatar"] },
  { id: "GAR-004", name: "fabric presets", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["listStudioFabricPresets"] },
  ...
  { id: "GAR-006", name: "avatar collision proxy", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["buildStudioAvatarCollisionProxy"] },
  { id: "GAR-007", name: "pin/tack/freeze", priority: "P3", status: "shipped", module: "studio-cloth-pattern-kernel.ts", apis: ["pinStudioClothParticles", "createStudioClothGrid"] },
  { id: "GAR-008", name: "pose-resimulation", priority: "P3", status: "shipped", module: "studio-cloth-pattern-kernel.ts", apis: ["stepStudioClothXpbd", "createStudioClothGrid"] },
  { id: "GAR-009", name: "garment skinning bake", priority: "P4", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["bakeStudioGarmentSkinning"] },
  { id: "GAR-010", name: "animation cloth cache", priority: "P4", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["cacheStudioAnimationCloth"] },
  { id: "GAR-011", name: "garment layer/order", priority: "P4", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["orderStudioGarmentLayers"] },
  { id: "GAR-012", name: "retopo/UV transfer", priority: "P4", status: "shipped", module: "studio-uv-unwrap-lite.ts", apis: ["unwrapStudioMeshBox"] },
  { id: "GAR-013", name: "DXF/AAMA pattern bridge", priority: "P4", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["bridgeStudioDxfAamaPattern"] },
  { id: "GAR-014", name: "CLO/Marvelous bridge", priority: "P4", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["bridgeStudioCloMarvelous"] },
  { id: "GAR-015", name: "comic wrinkle exaggeration", priority: "P4", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["exaggerateStudioComicWrinkle"] },
  ...
  { id: "MAT-005", name: "texture paint on 3D", priority: "P2", status: "shipped", module: "studio-hybrid-sculpt-kernel.ts", apis: ["polypaintStudioMesh"] },
  ...
  { id: "MAT-007", name: "procedural noise/pattern", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["generateStudioProceduralNoisePattern"] },
  { id: "MAT-008", name: "MaterialX import", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["importStudioMaterialXLite"] },
  ...
  { id: "MAT-011", name: "atlas/texture set", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["packStudioAtlasTextureSet"] },
  ...
  { id: "PRC-001", name: "typed node graph", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["evaluateStudioTypedNodeGraph"] },
  { id: "PRC-002", name: "instance/scatter", priority: "P2", status: "shipped", module: "studio-procedural-scatter.ts", apis: ["scatterStudioInstances"] },
  { id: "PRC-003", name: "cloner/effectors/fields", priority: "P3", status: "shipped", module: "studio-procedural-scatter.ts", apis: ["applyStudioClonerField", "scatterStudioInstances"] },
  { id: "PRC-004", name: "curve sweep/array", priority: "P2", status: "shipped", module: "studio-procedural-scatter.ts", apis: ["arrayStudioAlongCurve"] },
  ...
  { id: "PRC-006", name: "cache/bake/freeze", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["freezeStudioProceduralCacheBake"] },
  { id: "PRC-007", name: "custom script sandbox", priority: "P4", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["runStudioCustomScriptSandbox"] },
  { id: "PRC-008", name: "reusable generator asset", priority: "P3", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["registerStudioReusableGeneratorAsset"] },
  ...
  { id: "SHT-004", name: "continuity compare", priority: "P2", status: "shipped", module: "studio-shot-continuity.ts", apis: ["diffStudioShotContinuity"] },
  ...
  { id: "SHT-006", name: "storyboard/animatic", priority: "P2", status: "shipped", module: "studio-shot-continuity.ts", apis: ["buildStudioAnimaticTimeline"] },
  { id: "NPR-001", name: "depth/normal/object/material ID", priority: "P0", status: "shipped", module: "studio-live-2d3d-bridge.ts", apis: ["generateStudioToonPass"] },
  { id: "NPR-002", name: "silhouette/crease/boundary", priority: "P1", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["extractStudioSilhouetteCreaseBoundary"] },
  { id: "NPR-003", name: "intersection/contact line", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["detectStudioIntersectionContactLine"] },
  { id: "NPR-004", name: "tone/shadow region", priority: "P1", status: "shipped", module: "studio-live-2d3d-bridge.ts", apis: ["generateStudioToonPass"] },
  ...
  { id: "NPR-007", name: "line cleanup", priority: "P2", status: "shipped", module: "studio-dcc-domain-ops.ts", apis: ["cleanupStudioNprLine"] },
  { id: "NPR-008", name: "artist correction delta", priority: "P1", status: "shipped", module: "studio-artist-correction-delta.ts", apis: ["reprojectStudioArtistCorrections", "appendStudioArtistCorrection"] },
  ...
  { id: "DRW-007", name: "PSD/PSB import/export", priority: "P0", status: "shipped", module: "studio-dcc-material-publish-draw-lite.ts", apis: ["importStudioPsdPsbHeader", "exportStudioPsdPsbLite", "reportStudioPsdPsbCompatibility"] },
