...
const ROUTE_ROOTS = [
  ...
  "src/domains/creator/render/studio-gpu-bristle-host.ts",
] as const;
...
const WORKER = "src/domains/creator/render/studio-gpu-bristle.worker.ts";
const FABRIC = "src/domains/creator/render/studio-gpu-fabric.ts";
