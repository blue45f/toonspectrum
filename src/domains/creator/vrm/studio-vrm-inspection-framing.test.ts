...
describe("close-up inspection framing", () => {
  it("exposes unique real camera presets without changing the default", () => {
  ...
  it.each(crops)("frames $id on narrow and wide viewports", ({ id }) => {
  ...
  it("rejects missing, stale or nonfinite landmarks", () => {
