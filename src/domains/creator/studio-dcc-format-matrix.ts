...
export const STUDIO_DCC_FORMAT_MATRIX: readonly StudioFormatEntry[] = [
  ...
  { id: "fbx", extensions: [".fbx"], category: "mesh", grade: "B", path: "ufbx WASM / Assimp bridge", priority: "P2", notes: "vendor variance" },
  ...
  // CAD / BIM
  { id: "step", extensions: [".step", ".stp"], category: "cad", grade: "B", path: "occt-import-js (LGPL boundary)", priority: "P3", notes: "import loss report" },
  { id: "iges", extensions: [".iges", ".igs"], category: "cad", grade: "B", path: "occt-import-js", priority: "P3", notes: "same" },
