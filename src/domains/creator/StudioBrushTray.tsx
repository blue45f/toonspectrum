        ...
        {visible.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex h-9 min-w-[2.75rem] shrink-0 flex-col items-center justify-center gap-0.5 rounded-lg border px-1",
                STUDIO_EASE,
                STUDIO_FOCUS_RING,
                active
            ...
            >
              ...
              <span className="text-[0.55rem] font-semibold leading-none tracking-tight">{item.shortName}</span>
            </button>
          );
        })}
      </div>
