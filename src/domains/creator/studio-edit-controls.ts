...
export const STUDIO_EDIT_MENU_COMMANDS = {
  undo: { id: "undo", label: "실행취소", shortcut: "⌘Z" },
  redo: { id: "redo", label: "다시실행", shortcut: "⌘⇧Z" },
  cut: { id: "cut", label: "잘라내기", shortcut: "⌘X" },
  copy: { id: "copy", label: "복사", shortcut: "⌘C" },
  paste: { id: "paste", label: "붙여넣기", shortcut: "⌘V" },
  "paste-in-place": {
    id: "paste-in-place",
    label: "현재 위치에 붙여넣기",
    shortcut: "⌘⇧V",
  },
  "paste-file": { id: "paste-file", label: "이미지 파일 붙여넣기…" },
  "select-all": { id: "select-all", label: "모두 선택", shortcut: "⌘A" },
  deselect: { id: "deselect", label: "선택 해제", shortcut: "⌘D" },
  "invert-selection": {
    id: "invert-selection",
    label: "선택 반전",
    shortcut: "⌘⇧I",
  ...
  duplicate: { id: "duplicate", label: "복제", shortcut: "⌘J" },
  "bring-front": { id: "bring-front", label: "레이어 · 맨 위로", shortcut: "⌘⇧]" },
  "bring-forward": { id: "bring-forward", label: "레이어 · 위로", shortcut: "⌘]" },
  "send-back": { id: "send-back", label: "레이어 · 맨 뒤로", shortcut: "⌘[" },
  "send-backward": {
    id: "send-backward",
    label: "레이어 · 뒤로",
    shortcut: "⌘⇧[",
  },
  "crop-layer": { id: "crop-layer", label: "레이어 자르기…" },
  history: { id: "history", label: "작업 내역" },
  "pen-pressure": { id: "pen-pressure", label: "펜 압력 설정…" },
  "app-settings": { id: "app-settings", label: "애플리케이션 설정…" },
} as const;
