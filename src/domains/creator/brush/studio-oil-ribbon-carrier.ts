 ...
 * - the product oil/acrylic beds and the Fluid Paint family (oil, acrylic, fluid-paint and its
 *   fine/load/rake variants) run all three: a loaded tuft that depletes as it travels and
...
export function studioOilRibbonProgramsForBrush(
   ...
   * plan, which the program-set contract test pins for all eleven ids and the default.
   */
