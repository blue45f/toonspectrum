...
const DESCRIPTOR_ROWS: readonly DescriptorRow[] = [
  ...
  ["안개 소프트", "안개", "여러 번 쌓아 은은한 명암을 만드는 초연질 촉", "paint", 52, 0.58, "airbrush", "paint", "soft", 0.84],
  ...
  ["보케 빛망울", "보케", "크기와 농도가 다른 부드러운 빛망울을 흩뿌려 배경 보케 효과를 만드는 촉", "effect", 48, 0.5, "airbrush", "fx", "glitter", 0.92],
  ...
  ["4B 거친 연필", "4B 연필", "무른 4B 심이 종이 요철에 굵고 거칠게 갈리는 러프 스케치 연필", "sketch", 9, 0.8, "dry-media", "line", "texture", 0.42],
  ["HB 샤프 연필", "HB 샤프", "필압 변화가 적은 단단한 샤프심으로 밑그림 보조선을 고르게 긋는 연필", "sketch", 2, 0.92, "dry-media", "line", "dashed", 0.14],
  ["부드러운 색연필", "색연필", "칠할 때마다 색상이 미묘하게 흔들리는 왁스심 색연필 특유의 혼색 결", "sketch", 7, 0.78, "dry-media", "line", "texture", 0.36],
  ["목탄 연필", "목탄심", "심이 부서지며 가루가 번지는 목탄 특유의 깊고 어두운 소묘 획", "sketch", 12, 0.7, "dry-media", "texture", "texture", 0.5],
  ["기울임 음영 연필", "기울임 음영", "펜을 눕히면 심 측면이 닿듯 획이 넓어지는 틸트 반응 음영 연필", "sketch", 14, 0.6, "dry-media", "texture", "soft", 0.55],
  ["탄력 G펜", "G펜", "필압에 따라 극적으로 굵어지고 끝이 길게 빠지는 만화 잉킹 대표 펜촉", "ink", 7, 1, "ink-particle", "line", "calligraphy", 0.44],
  ["마루펜 세필", "마루펜", "약한 필압 반응의 단단한 세필 펜촉으로 머리카락과 배경 선을 잇는 촉", "ink", 3, 1, "ink-particle", "line", "solid", 0.2],
  ["스푼펜 라운드", "스푼펜", "가벼운 힘에도 부드럽게 굵어져 대사 선과 효과선에 두루 쓰는 펜촉", "ink", 5, 1, "ink-particle", "line", "solid", 0.3],
  ["먹 붓펜", "붓펜", "빠르게 그으면 가늘어지고 눌러 끌면 먹이 배어나는 모필 붓펜", "ink", 12, 0.98, "ink-particle", "line", "calligraphy", 0.55],
  ["틸트 캘리그래피 펜", "캘리그래피", "스타일러스 기울기 방위를 따라 납작한 촉이 회전하는 레터링 펜", "ink", 16, 0.96, "ink-particle", "line", "calligraphy", 0.6],
  ["밀리펜 0.5", "밀리펜", "필압을 무시하고 처음부터 끝까지 균일한 굵기를 지키는 제도용 라이너", "ink", 4, 1, "ink-particle", "line", "solid", 0.24],
  ["젖은 수채 번짐", "수채 번짐", "물을 많이 머금은 붓이 종이 위에서 몽글하게 퍼지는 습식 수채 획", "paint", 30, 0.56, "airbrush", "paint", "soft", 0.8],
  ["수채 얼룩 가장자리", "얼룩 수채", "마르며 가장자리에 안료가 고이는 워터마크 얼룩을 겹쳐 쌓는 수채 촉", "paint", 38, 0.44, "airbrush", "paint", "soft", 0.86],
  ["유화 임파스토", "임파스토", "촘촘한 강모 자국과 두꺼운 물감 융기가 남는 고점도 유화 나이프 붓", "paint", 26, 0.95, "ink-particle", "paint", "oil", 0.78],
  ["오일 드라이브러시", "드라이브러시", "빠른 획에서 물감이 갈라지고 끊기는 마른 유화 스컴블 붓", "paint", 22, 0.85, "dry-media", "paint", "texture", 0.72],
  ["종이결 파스텔", "파스텔", "캔버스에 고정된 종이 이빨 위로 분이 얹히는 소프트 파스텔", "chalk", 20, 0.72, "dry-media", "texture", "soft", 0.68],
  ["왁스 크레용", "크레용", "획을 따라 왁스 줄무늬가 끌리는 어린이 그림책 감성의 크레용", "chalk", 13, 0.9, "dry-media", "texture", "texture", 0.56],
  ["대구경 에어브러시", "대구경 에어", "그라데이션과 피부 명암을 한 번에 덮는 초대형 연질 분사 노즐", "paint", 64, 0.58, "airbrush", "paint", "soft", 1],
  ["스펀지 스티플", "스티플", "간격을 두고 도장처럼 찍히는 스펀지 두들김으로 질감을 쌓는 촉", "texture", 24, 0.8, "dry-media", "texture", "dots", 0.7],
  ["저유량 글레이즈 마커", "글레이즈", "옅은 현재색을 여러 번 겹쳐 경계와 농담을 부드럽게 연결하는 저유량 마커", "marker", 30, 0.4, "airbrush", "marker", "soft", 0.8],
  ["광폭 사각 마커", "광폭 마커", "고정 각도의 넓은 사각 촉으로 포스터 면을 단숨에 채우는 마커", "marker", 40, 0.55, "ink-particle", "marker", "calligraphy", 0.9],
  ["노이즈 스프레이", "노이즈", "미세 입자를 넓은 반경에 뿌려 노이즈 질감을 만드는 스프레이", "effect", 34, 0.5, "airbrush", "fx", "dots", 0.85],
  ["별가루 스캐터", "별가루", "회전과 크기가 제각각인 별 조각을 흩뿌리는 반짝임 장식 촉", "effect", 28, 0.85, "ink-particle", "fx", "glitter", 0.76],
  ["낙엽 흩날림", "낙엽", "색이 조금씩 다른 잎이 바람에 구르듯 흩어지는 가을 낙엽 촉", "foliage", 30, 0.82, "ink-particle", "paint", "glitter", 0.8],
  ["뭉게구름 스모크", "뭉게구름", "큰 노이즈 덩어리로 구름과 연기 볼륨을 뭉게뭉게 쌓는 초연질 촉", "effect", 56, 0.44, "airbrush", "fx", "soft", 0.95],
  ["로프 꼬임 스탬프", "로프", "획 방향을 따라 꼬임 마디가 일정 간격으로 이어지는 밧줄 스탬프", "stamp", 22, 0.94, "ink-particle", "fx", "dashed", 0.66],
  ["성긴 망점", "성긴 망점", "필압으로 점 크기가 자라는 성긴 망점으로 밝은 스크린톤 농담을 까는 촉", "tone", 26, 0.9, "ink-particle", "texture", "tone", 0.72],
  ["사선 빗줄기", "빗줄기", "고정된 사선 각도로 내리긋는 빗줄기를 속도에 따라 흩는 효과 촉", "effect", 26, 0.62, "ink-particle", "fx", "dashed", 0.74],
  ["스파클 글린트", "스파클", "십자 빛이 터지는 반짝임을 드문드문 찍는 하이라이트 장식 촉", "effect", 30, 0.9, "ink-particle", "fx", "glitter", 0.8],
  ["눈송이 플러리", "눈송이", "결정 조각이 흔들리며 떨어지는 함박눈을 흩뿌리는 겨울 효과 촉", "effect", 32, 0.75, "ink-particle", "fx", "dots", 0.82],
  ["잉크 스플래터", "스플래터", "누를수록 방울이 넓게 터지는 잉크 튀김 얼룩을 뿌리는 촉", "texture", 30, 0.85, "ink-particle", "fx", "dots", 0.8],
  ["보송 털뭉치", "털뭉치", "결이 벌어지는 짧은 털 다발로 동물 털과 모피 러프를 잡는 붓", "rake", 18, 0.8, "ink-particle", "texture", "dashed", 0.6],
  ["나무결 라이너", "나무결", "굽이치는 섬유선이 나이테처럼 흐르는 목재 표면 묘사 붓", "texture", 28, 0.78, "dry-media", "texture", "wavy", 0.76],
  // ── 2026-07 재료·장식·효과 확장 웨이브(40) ───────────────────────────
  ["물먹인 둥근 강모", "둥근 강모", "물감이 실린 둥근 강모 다발이 압력에 따라 풍성하게 벌어지는 채색 붓", "paint", 24, 0.92, "ink-particle", "paint", "oil", 0.72],
  ["마른 부채 강모", "부채 강모", "부채꼴로 벌어진 마른 털끝이 표면의 돌출부만 성기게 훑는 질감 붓", "rake", 34, 0.72, "dry-media", "texture", "dashed", 0.84],
  ["결무늬 납작 강모", "납작 강모", "서로 다른 굵기의 강모 줄이 납작한 획 안에서 자연스럽게 갈라지는 붓", "paint", 30, 0.88, "dry-media", "paint", "texture", 0.78],
  ["팔레트 나이프 날", "나이프 날", "기울어진 얇은 날과 물감이 뭉친 모서리로 능선과 하이라이트를 긁는 도구", "paint", 32, 0.96, "ink-particle", "paint", "oil", 0.82],
  ["마른 수채 과립", "마른 수채", "물기가 적은 안료 알갱이가 종이 골을 따라 끊겨 쌓이는 수채 붓", "paint", 25, 0.56, "dry-media", "paint", "texture", 0.72],
  ["소금꽃 수채", "소금꽃", "젖은 수채 위에서 소금 결정처럼 밝은 틈과 방사 무늬를 남기는 효과 붓", "paint", 38, 0.42, "airbrush", "paint", "glitter", 0.88],
  ["역번짐 고리", "역번짐", "마르는 물웅덩이 가장자리로 안료가 되밀려 불규칙한 고리를 만드는 수채 촉", "paint", 46, 0.38, "airbrush", "paint", "soft", 0.92],
  ["습식 넓은 워시", "습식 워시", "넓은 물층이 겹치며 가장자리 농도와 속도별 물감량이 달라지는 워시 붓", "paint", 58, 0.42, "airbrush", "paint", "soft", 0.96],
  ["입자 구아슈 평붓", "구아슈 평붓", "매트한 불투명 물감 사이로 미세한 입자 결이 드러나는 평면 채색 붓", "paint", 34, 0.9, "dry-media", "paint", "oil", 0.82],
  ["탄성 아크릴 평붓", "아크릴 평붓", "단단한 합성모가 진행 방향을 따라 정렬되며 선명한 모서리를 남기는 붓", "paint", 28, 0.94, "ink-particle", "paint", "calligraphy", 0.76],
  ["린넨 유화 필버트", "유화 필버트", "둥근 납작 강모와 캔버스 직조가 겹쳐 두터운 유화 결을 만드는 붓", "paint", 30, 0.94, "dry-media", "paint", "oil", 0.8],
  ["먹물 갈라짐 워시", "먹 워시", "속도와 압력에 따라 먹 중심과 갈라진 모필 가장자리가 함께 변하는 붓", "ink", 26, 0.78, "dry-media", "paint", "wavy", 0.7],
  ["새틴 접힘 리본", "새틴 리본", "진행 방향을 따라 명암 띠가 접히며 이어지는 윤기 있는 리본 장식 붓", "pattern", 28, 0.94, "ink-particle", "fx", "wavy", 0.8],
  ["두 겹 꼬임 끈", "겹 꼬임 끈", "두 가닥의 밝고 어두운 꼬임이 연속적으로 맞물리는 장식용 끈 붓", "pattern", 24, 0.92, "ink-particle", "fx", "dashed", 0.72],
  ["교대 사슬 고리", "사슬 고리", "가로와 세로 방향의 금속 고리가 번갈아 연결되는 체인 스탬프", "stamp", 26, 0.96, "ink-particle", "fx", "solid", 0.74],
  ["물결 레이스 테두리", "레이스", "반원 물결과 작은 구멍 장식이 일정하게 이어지는 섬세한 레이스 붓", "pattern", 30, 0.9, "ink-particle", "fx", "glitter", 0.78],
  ["러닝 스티치 실", "러닝 스티치", "짧은 실땀과 빈 간격이 획 방향을 따라 단정하게 반복되는 봉제 붓", "pattern", 12, 0.96, "ink-particle", "fx", "dashed", 0.48],
  ["십자 봉제선", "십자 봉제", "작은 교차 실밥이 균일한 간격으로 이어져 천의 봉제선을 만드는 붓", "pattern", 16, 0.94, "ink-particle", "fx", "tone", 0.56],
  ["니트 고리 직조", "니트 고리", "서로 걸린 실 고리와 미세한 섬유 결로 뜨개 표면을 빠르게 채우는 촉", "texture", 28, 0.76, "dry-media", "texture", "texture", 0.76],
  ["금속 긁힘 결", "금속 긁힘", "길이와 밝기가 다른 미세한 사선 흠집을 겹쳐 금속 표면을 표현하는 붓", "texture", 24, 0.64, "dry-media", "texture", "dashed", 0.68],
  ["겹연기 실루엣", "겹연기", "휘어지는 연기 가닥과 부드러운 입자층을 겹쳐 깊이 있는 연무를 만드는 붓", "effect", 52, 0.36, "airbrush", "fx", "soft", 0.96],
  ["불꽃 혀와 불티", "불꽃 불티", "가늘어지는 불꽃 혀와 작은 불티가 속도에 반응하며 함께 솟는 효과 붓", "effect", 34, 0.82, "ink-particle", "fx", "glitter", 0.84],
  ["빗줄기 안개 혼합", "비안개", "긴 빗줄기와 옅은 물안개 입자가 한 획에서 층을 이루는 날씨 효과 붓", "effect", 38, 0.5, "airbrush", "fx", "dashed", 0.86],
  ["가루눈 포말", "가루눈", "작은 결정과 흐릿한 눈가루가 바람 방향으로 층층이 흩날리는 효과 붓", "effect", 44, 0.52, "airbrush", "fx", "dots", 0.9],
  ["원근 먼지 입자", "원근 먼지", "크기와 농도가 다른 먼지 입자로 빛 속의 공간 깊이를 만드는 산란 붓", "effect", 40, 0.36, "airbrush", "fx", "dots", 0.88],
  ["무대 잉크 튐", "무대 잉크", "폭력적 소재 없이 연출용 페인트 방울과 꼬리를 안전하게 흩뿌리는 효과 붓", "effect", 32, 0.84, "ink-particle", "fx", "dots", 0.82],
  ["고리 빛망울", "고리 빛망울", "속이 비친 원형 빛 테두리를 크기와 밝기 차이로 겹쳐 장면의 심도를 만드는 붓", "effect", 42, 0.48, "airbrush", "fx", "glitter", 0.9],
  ["권운 흐름", "권운", "길고 가는 구름 가닥이 획의 흐름을 따라 휘어져 하늘의 방향감을 만드는 붓", "effect", 58, 0.38, "airbrush", "fx", "wavy", 0.96],
  ["넓은 수관 잎송이", "넓은 수관", "크기가 다른 넓은 잎송이를 색 변화와 함께 겹쳐 풍성한 수관을 만드는 붓", "foliage", 42, 0.76, "ink-particle", "paint", "glitter", 0.9],
  ["나무껍질 균열", "나무껍질", "수직 섬유와 불규칙한 갈라짐을 함께 쌓아 굵은 나무껍질을 표현하는 촉", "texture", 34, 0.8, "dry-media", "texture", "texture", 0.8],
  ["꽃잎 흩날림", "꽃잎", "다섯 갈래 꽃잎과 낱잎이 회전하며 흩어지는 계절 장식 붓", "foliage", 28, 0.86, "ink-particle", "paint", "glitter", 0.78],
  ["암석 파편 결", "암석 파편", "각진 조각과 작은 균열이 서로 다른 크기로 쌓이는 바위 질감 붓", "texture", 36, 0.82, "dry-media", "texture", "texture", 0.84],
  ["엇갈린 벽돌 줄눈", "벽돌 줄눈", "엇갈린 벽돌 면과 가는 모르타르 선을 일정한 간격으로 이어 그리는 패턴", "pattern", 36, 0.9, "ink-particle", "texture", "tone", 0.84],
  ["옹이 나무 갈퀴", "옹이 갈퀴", "평행한 목재 섬유가 옹이를 돌아 굽이치며 이어지는 방향성 갈퀴 붓", "rake", 34, 0.76, "dry-media", "texture", "wavy", 0.82],
  ["부드러운 속털", "속털", "짧고 흐릿한 속털과 선명한 겉털을 겹쳐 동물의 부피감을 만드는 붓", "rake", 22, 0.66, "airbrush", "texture", "soft", 0.68],
  ["곱슬 모발 리본", "곱슬 모발", "굵은 곱슬 가닥과 가는 잔머리를 하나의 흐르는 획으로 묶는 헤어 붓", "rake", 18, 0.88, "ink-particle", "line", "wavy", 0.62],
  ["참깨 토핑 산란", "참깨 토핑", "방향과 색이 조금씩 다른 작은 타원 알갱이를 음식 위에 자연스럽게 뿌리는 붓", "stamp", 20, 0.92, "ink-particle", "fx", "dots", 0.6],
  ["점증 망점 그라데이션", "점증 망점", "필압과 속도에 따라 점 크기와 간격이 함께 변해 부드러운 망점 농담을 만드는 촉", "tone", 28, 0.88, "ink-particle", "texture", "tone", 0.74],
  ["윤곽 추종 해칭", "윤곽 해칭", "진행 방향과 펜 기울기를 따라 평행선 각도가 자연스럽게 바뀌는 명암 갈퀴", "tone", 26, 0.82, "dry-media", "texture", "dashed", 0.7],
  ["집중 방사선", "집중선", "빠른 획에서 중심을 향한 가는 방사선과 잔선을 길게 뽑는 만화 효과 붓", "effect", 30, 0.94, "ink-particle", "fx", "wavy", 0.8],
];
