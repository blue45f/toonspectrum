...
import { StudioBg3dAssetLibraryPanel as ExistingAssetLibraryPanel } from "./StudioBg3dAssetLibraryPanelBase";
...
/** The existing panel still owns the real file input and rights form. */
export function StudioBg3dAssetLibraryPanel(props: Props) {
  ...
  const handOffFile = (file: File): void => {
    ...
    // A real DOM change event reuses the existing rights selection and import/validation owner.
