...
const PILLARS = [
  {
    ...
    title: "베이즈 평점",
    sub: "적은 표본 보정",
    body: "평가 수가 적은 작품의 평점은 쉽게 출렁입니다. 평가 3개로 5.0인 작품과 평가 1만 개로 4.6인 작품을 같은 줄에 세우면 안 되죠. 그래서 사전 평균 C=4.0에 가중 표본 m=800을 더해, 평가가 쌓일수록 자기 점수에 가까워지게 보정합니다.",
    formula: "bayes = (4.0×800 + 평균평점×평가수) / (800 + 평가수)",
  },
  {
    icon: Sigma,
    title: "인기 백분위",
