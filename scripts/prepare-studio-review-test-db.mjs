...
try {
  ...
  for (const migration of ["0064_studio_project_graph_v3.sql", "0077_membership_operations.sql", "0082_studio_review_policy.sql", "0083_studio_review_vote_epoch.sql", "0084_studio_pinned_review_share.sql"]) {
