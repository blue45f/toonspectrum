...
const required = [
  ...
  "apps/web/src/domains/creator/assistant/studio-webtoon-assistant-document.ts",
  "apps/web/src/domains/creator/storyworld/studio-storyworld-project-projection.ts",
  ...
  "apps/web/src/domains/creator/export/studio-vector-pdf-product.ts",
  "apps/web/src/domains/creator/color/StudioColorProofContext.tsx",
  "apps/web/src/domains/creator/color/StudioColorProofDialog.tsx",
  "apps/web/src/domains/creator/StudioPageGradePanel.tsx",
  ...
  "apps/web/src/domains/creator/studio-shell/creator-essentials/CreatorEssentialsPage.tsx",
  "apps/web/src/domains/creator/studio-shell/creator-essentials/creator-essentials-catalog.ts",
