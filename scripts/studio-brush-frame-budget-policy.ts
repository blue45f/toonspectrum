// Exercise the current picker roster. Retired duplicate presets remain readable in old documents,
// but their listed replacements must carry these pencil, airbrush, watercolor and ink workloads.
...
export const STUDIO_BRUSH_COMPETITIVE_PROVIDER_ROUTES = {
  ...
  "precision-pencil": "canvas2d-dynamic-coverage",
  ...
  "mist-soft": "canvas2d-dynamic-coverage",
  "airbrush-fine": "canvas2d-stamp",
  "standard-eraser": "konva-eraser-mask",
  watercolor: "canvas2d-dynamic-coverage",
  "ink-wash--sumi-core": "canvas2d-dynamic-coverage",
  "watercolor--edge-bloom": "canvas2d-dynamic-coverage",
  "rough-ink": "canvas2d-dynamic-coverage",
