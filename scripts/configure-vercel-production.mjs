...
const FORWARDED_SECRET_KEYS = [
  "DATABASE_URL",
  ...AUTH_RUNTIME_KEYS,
  ...PRIVATE_OBJECT_STORAGE_RUNTIME_KEYS,
  "OPENAI_API_KEY",
  "OPENROUTER_API_KEY",
...
const PUBLIC_VALUES = new Map([
  ...
  [
    "KAKAO_ACCOUNT_EMAIL_SCOPE_ENABLED",
    process.env.KAKAO_ACCOUNT_EMAIL_SCOPE_ENABLED_VALUE?.trim() === "true"
      ? "true"
      : "false",
  ],
]);
