...
const V5_DEFAULT_BACKGROUND_URL = "/assets/virtual-studio/style-packs-v5/sky-island/world/world-base.webp";
const V5_DEFAULT_BACKGROUND_DIMENSIONS = [1280, 960];
...
/** Ensure the generated world binds the independent v5 sky-island base while the legacy clean plate remains separately verified. */
export async function verifyVirtualStudioLivingWorldBindings({
  ...
  requireCondition(backgroundUrl === V5_DEFAULT_BACKGROUND_URL
    && layer?.image === V5_DEFAULT_BACKGROUND_URL,
  "generated default world must reference the verified independent v5 sky-island base");
  requireCondition(layer.imagewidth === V5_DEFAULT_BACKGROUND_DIMENSIONS[0]
    && layer.imageheight === V5_DEFAULT_BACKGROUND_DIMENSIONS[1],
  "generated default world must retain the v5 background's actual dimensions");
  ...
  requireCondition(runtime.includes(`backgroundUrl: "${V5_DEFAULT_BACKGROUND_URL}"`),
    "runtime default manifest must use the verified independent v5 sky-island URL");
  return true;
}
