...
const requiredPaths = [
  ...
  "docs/studio-autonomous-upgrade-policy-2026-09-02.md",
  "docs/studio-clip-studio-parity-program-2026-09-02.md",
  "docs/studio-third-party-reuse-policy-2026-09-02.md",
  "docs/studio-seven-day-autonomous-campaign-2026-09-02.md",
  ...
  "docs/benchmarks/studio-emerging-research-intake-2026-09-02.md",
  "docs/benchmarks/studio-research-registry.json",
  "docs/third-party/studio-owner-attestation-2026-09-02.md",
  ...
  "scripts/studio-autonomous-change-plan.mjs",
  "scripts/studio-autonomous-change-plan.test.mjs",
  "scripts/studio-merged-branch-cleanup.mjs",
  "scripts/studio-merged-branch-cleanup.test.mjs",
  "scripts/validate-studio-competitor-registry.mjs",
  "scripts/validate-studio-competitor-registry.test.mjs",
  "scripts/studio-competitor-watch.mjs",
  "scripts/studio-competitor-watch.test.mjs",
  "scripts/studio-emerging-product-watch.mjs",
  "scripts/studio-emerging-product-watch.test.mjs",
  "scripts/studio-research-watch.mjs",
  "scripts/studio-research-watch.test.mjs",
  "scripts/studio-seven-day-campaign.mjs",
  "scripts/studio-seven-day-campaign.test.mjs",
  "scripts/studio-campaign-patch-policy.mjs",
  "scripts/studio-campaign-patch-policy.test.mjs",
  "scripts/validate-studio-third-party-reuse.mjs",
  "scripts/validate-studio-third-party-reuse.test.mjs",
  ".husky/pre-commit",
  ".husky/commit-msg",
];
