...
const forbiddenOneOffWorkflows = [
  ...
  "one-time-delete-obsolete-language-branch.yml",
  "bg3d-runtime-regression.yml",
  "studio-ink-live-commit.yml",
  "market-integration-apply.yml",
  "market-workspace-snapshot.yml",
  "studio-premium-world-build.yml",
  "studio-premium-world-polish.yml",
  "studio-premium-world-repair.yml",
  "studio-premium-world-verify.yml",
  "recover-studio-gpt25-background-atlas.yml",
];
forbidPaths(
