...
import { privateObjectStorageRoutingFingerprint } from "../apps/api/src/platform/adapters/private-object-storage/private-object-storage.config";
import {
  PRIVATE_OBJECT_STORAGE_PROVIDER_IDS,
  type PrivateObjectStorageProviderId,
  type PrivateObjectStoragePurposeRouting,
} from "../apps/api/src/platform/adapters/private-object-storage/purpose-routed-private-object-storage.port";
