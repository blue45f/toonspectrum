/** Page coordinator for close/reopen and forced Dedicated Worker termination evidence. */

const RESULT_GLOBAL = "__TOONSPECTRUM_MANNEQUIN_BG3D_SQLITE_OPFS_RESULT__";
...
function runWorkerPhase(
  ...
  return new Promise((resolve, reject) => {
    const worker = new Worker(
      new URL("./mannequin-bg3d-preset-sqlite-opfs-browser-client.ts", import.meta.url),
      { type: "module", name: `mannequin-bg3d-sqlite-opfs-${phase}` },
    );
