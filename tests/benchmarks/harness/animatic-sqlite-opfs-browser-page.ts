/** Main-page launcher for the Dedicated Worker animatic SQLite OPFS benchmark. */

const RESULT_GLOBAL = "__TOONSPECTRUM_ANIMATIC_SQLITE_OPFS_BROWSER_RESULT__";
...
async function run(): Promise<void> {
  ...
  const worker = new Worker(
    new URL("./animatic-sqlite-opfs-browser-client.ts", import.meta.url),
    { type: "module", name: "animatic-sqlite-opfs-sahpool-benchmark" },
  );
