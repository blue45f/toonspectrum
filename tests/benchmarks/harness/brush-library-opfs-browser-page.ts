/** Main-page launcher for the dedicated-worker OPFS SQLite benchmark. */

const RESULT_GLOBAL = "__TOONSPECTRUM_BRUSH_LIBRARY_OPFS_BROWSER_RESULT__";
...
async function run(): Promise<void> {
  ...
  const worker = new Worker(
    new URL("./brush-library-opfs-browser-client.ts", import.meta.url),
    { type: "module", name: "brush-library-opfs-sahpool-benchmark" },
  );
