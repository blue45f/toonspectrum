...
const dispatcherPath = fileURLToPath(
  new URL("../../../../../../apps/api/src/modules/creator/studio-live-cleanup-notification-dispatcher.ts", import.meta.url)
);
const gatewayPath = fileURLToPath(new URL("../../../../../../apps/api/src/modules/creator/studio-live.gateway.ts", import.meta.url));
const cleanupPath = fileURLToPath(new URL("../../../../../../apps/api/src/modules/creator/studio-live-gateway-cleanup.ts", import.meta.url));
const creatorModulePath = fileURLToPath(new URL("../../../../../../apps/api/src/modules/creator/creator.module.ts", import.meta.url));
const clientPresencePath = fileURLToPath(
  new URL(
    "../../../../../../apps/web/src/domains/creator/live/studio-live-socket-transport-presence.ts",
    import.meta.url
  )
);
const clientVoicePath = fileURLToPath(
  new URL(
    "../../../../../../apps/web/src/domains/creator/live/studio-live-socket-transport-voice.ts",
    import.meta.url
  )
);
