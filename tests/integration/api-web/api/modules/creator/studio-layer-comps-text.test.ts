...
import { hasValidStudioCrdtRootSchema } from "../../../../../../apps/api/src/modules/creator/studio-crdt-root-schema";
import { captureLayerComp, type StudioLayerComp } from "../../../../../../apps/web/src/domains/creator/layer/studio-layer-comps";
import { parseStudioLayerComps } from "../../../../../../apps/web/src/domains/creator/layer/studio-layer-comps-document";
import { StudioCrdtDocument } from "../../../../../../apps/web/src/domains/creator/live/studio-crdt-document";
import { studioPageToCrdtPage } from "../../../../../../apps/web/src/domains/creator/live/studio-crdt-page-payload";
import { parseStudioProjectFile, serializeStudioProjectFile } from "../../../../../../apps/web/src/domains/creator/studio-project-file";
