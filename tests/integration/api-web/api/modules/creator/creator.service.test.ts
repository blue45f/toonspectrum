...
} from "../../../../../../apps/api/src/modules/creator/creator-draft-collaboration.repository";
import { planCreatorPublicationMediaMutation } from "../../../../../../apps/api/src/modules/creator/creator-publication-media.contract";
import {
  CreatorPublicationMediaService,
  CreatorPublicationMediaStorageUnavailableError,
} from "../../../../../../apps/api/src/modules/creator/creator-publication-media.service";
...
import { StudioLinked3dPassAssetFenceError } from
  "../../../../../../apps/web/src/shared/lib/studio-linked-3d-pass-asset-fence";

import type { StudioWorkAssetService } from "../../../../../../apps/api/src/modules/creator/studio-work-asset.service";
...
vi.mock("../../../../../../apps/api/src/server/creator", () => ({
  addComment: vi.fn(),
  bumpAssetDownloads,
  bumpViews,
  createSeries: vi.fn(),
