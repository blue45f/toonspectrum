...
} from "../../../../../../apps/web/src/shared/lib/studio-linked-3d-pass-asset-fence";
...
describe("creator draft collaboration SQL boundary", () => {
  it("ships an indexed FK-safe marker migration with lease, size and promotion constraints", () => {
    const migration = readFileSync(
      new URL(
        "../../../../../../apps/api/src/platform/database/migrations/0020_creator_draft_collaboration_room.sql",
        import.meta.url
      ),
      "utf8"
    );
  ...
  it("widens the provision intent check through a validated forward migration", () => {
    const migration = readFileSync(
      new URL(
        "../../../../../../apps/api/src/platform/database/migrations/0026_creator_draft_cloud_save_intent.sql",
        import.meta.url
      ),
      "utf8"
    );
  ...
  it("serializes provision admission across API nodes before count or insert", () => {
    const source = readFileSync(
      new URL("../../../../../../apps/api/src/modules/creator/creator-draft-collaboration.repository.ts", import.meta.url),
      "utf8"
    );
