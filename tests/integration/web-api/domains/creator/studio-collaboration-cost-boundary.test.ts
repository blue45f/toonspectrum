...
describe("studio collaboration cost boundary", () => {
  it("keeps legacy TURN-capable voice out of the collaboration shell", () => {
    const reachableSource = [
      "../../../../../apps/web/src/domains/creator/live/StudioLiveCollaborationProvider.tsx",
      "../../../../../apps/web/src/domains/creator/live/studio-live-collaboration-context.ts",
  ...
  it("keeps the new huddle RTC-only without credential endpoints or recording", () => {
    const huddle = source("../../../../../apps/web/src/domains/creator/live/huddle/studio-p2p-huddle-controller.ts");
    const policy = source("../../../../../apps/web/src/domains/creator/live/huddle/studio-p2p-huddle-protocol.ts");
