...
const migration = readFileSync(
  new URL("../../../../../apps/api/src/platform/database/migrations/0021_creator_marketplace_resource.sql", import.meta.url),
  "utf8"
);
...
const client = readFileSync(
  new URL("../../../../../apps/web/src/platform/creator-marketplace-client.ts", import.meta.url),
  "utf8"
);
