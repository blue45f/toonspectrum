...
import { parseReferenceNotes, referenceNotesMarkdown, writeReferenceNotes } from "../../../../../../apps/web/src/domains/catalog/references/reference-storage";
import { normalizeReferenceItem, normalizeReferenceResponse, parseReferenceQuery, ReferenceError, REFERENCE_FIELDS } from "../../../../../../apps/web/src/shared/lib/kmas-reference";

import type { ReferenceField } from "../../../../../../apps/web/src/shared/lib/kmas-reference";
