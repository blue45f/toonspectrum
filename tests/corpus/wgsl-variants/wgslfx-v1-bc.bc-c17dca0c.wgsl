// wgsl-variant wgslfx-v1-bc.bc-c17dca0c
// structure: v1:brightness-contrast[brightness,contrast]|brightness-contrast[brightness,contrast]
struct Params {
  pixel_count : u32,
  _pad0 : u32,
  _pad1 : u32,
...
fn main(@builtin(global_invocation_id) gid : vec3<u32>) {
  ...
  g = lut[256u + g] & 0xffu;
  b = lut[512u + b] & 0xffu;
  // stage 1: brightness-contrast (lut base 768)
  r = lut[768u + r] & 0xffu;
  g = lut[1024u + g] & 0xffu;
  b = lut[1280u + b] & 0xffu;
